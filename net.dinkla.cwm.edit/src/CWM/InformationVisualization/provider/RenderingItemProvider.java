...
import CWM.Core.provider.FeatureItemProvider;
...
/**
 * This is the item provider adapter for a {@link CWM.InformationVisualization.Rendering} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
	...
	protected void addRenderedObjectPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Rendering_renderedObject_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Rendering_renderedObject_feature", "_UI_Rendering_type"),
				 InformationVisualizationPackage.Literals.RENDERING__RENDERED_OBJECT,
				 true,
				 false,
				 true,
				 null,
