...
/**
 * This is the item provider adapter for a {@link CWM.MiningCore.MiningTask.MiningApplyOutput} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class MiningApplyOutputItemProvider
	 ...
	 * @generated
	 */
	public MiningApplyOutputItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(MiningTaskPackage.Literals.MINING_APPLY_OUTPUT__ITEM);
		}
	...
	/**
	 * This returns MiningApplyOutput.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/MiningApplyOutput"));
	}
	...
	public String getText(Object object) {
		String label = ((MiningApplyOutput)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_MiningApplyOutput_type") :
			getString("_UI_MiningApplyOutput_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(MiningApplyOutput.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(MiningTaskPackage.Literals.MINING_APPLY_OUTPUT__ITEM,
