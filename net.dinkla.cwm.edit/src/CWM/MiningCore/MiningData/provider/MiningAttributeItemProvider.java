...
/**
 * This is the item provider adapter for a {@link CWM.MiningCore.MiningData.MiningAttribute} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class MiningAttributeItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_MiningAttribute_displayName_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_MiningAttribute_displayName_feature", "_UI_MiningAttribute_type"),
				 MiningDataPackage.Literals.MINING_ATTRIBUTE__DISPLAY_NAME,
				 true,
				 false,
				 false,
	...
	protected void addAttributeTypePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_MiningAttribute_attributeType_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_MiningAttribute_attributeType_feature", "_UI_MiningAttribute_type"),
				 MiningDataPackage.Literals.MINING_ATTRIBUTE__ATTRIBUTE_TYPE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(MiningAttribute.class)) {
