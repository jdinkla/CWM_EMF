...
/**
 * This is the item provider adapter for a {@link CWM.MiningCore.MiningData.CategoryMap} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class CategoryMapItemProvider
	 ...
	 * @generated
	 */
	public CategoryMapItemProvider(AdapterFactory adapterFactory) {
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/CategoryMap"));
	}
	...
	public String getText(Object object) {
		String label = ((CategoryMap)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_CategoryMap_type") :
			getString("_UI_CategoryMap_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(CategoryMap.class)) {
