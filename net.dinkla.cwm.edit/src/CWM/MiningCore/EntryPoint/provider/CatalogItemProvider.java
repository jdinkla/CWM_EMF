...
/**
 * This is the item provider adapter for a {@link CWM.MiningCore.EntryPoint.Catalog} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class CatalogItemProvider
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(EntryPointPackage.Literals.CATALOG__SCHEMA);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Catalog.class)) {
			case EntryPointPackage.CATALOG__SCHEMA:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(EntryPointPackage.Literals.CATALOG__SCHEMA,
	...
	public String getCreateChildText(Object owner, Object feature, Object child, Collection<?> selection) {
		...
		boolean qualify =
			...
			childFeature == EntryPointPackage.Literals.CATALOG__SCHEMA;
