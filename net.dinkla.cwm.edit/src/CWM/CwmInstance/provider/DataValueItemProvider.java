...
/**
 * This is the item provider adapter for a {@link CWM.CwmInstance.DataValue} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DataValueItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 CwmInstancePackage.Literals.DATA_VALUE__VALUE,
				 true,
				 false,
				 false,
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(DataValue.class)) {
			case CwmInstancePackage.DATA_VALUE__VALUE:
