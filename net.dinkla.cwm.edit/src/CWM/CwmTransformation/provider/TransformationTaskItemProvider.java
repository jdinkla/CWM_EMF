...
import CWM.SoftwareDeployment.provider.ComponentItemProvider;
...
/**
 * This is the item provider adapter for a {@link CWM.CwmTransformation.TransformationTask} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 CwmTransformationPackage.Literals.TRANSFORMATION_TASK__TRANSFORMATION,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 CwmTransformationPackage.Literals.TRANSFORMATION_TASK__INVERSE_TASK,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 CwmTransformationPackage.Literals.TRANSFORMATION_TASK__ORIGINAL_TASK,
				 true,
				 false,
				 true,
				 null,
