...
/**
 * This is the action bar contributor for the Supervised model editor.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SupervisedActionBarContributor
	 ...
	 * @generated
	 */
	public SupervisedActionBarContributor() {
	...
	public void contributeToToolBar(IToolBarManager toolBarManager) {
		toolBarManager.add(new Separator("supervised-settings"));
		toolBarManager.add(new Separator("supervised-additions"));
	}
	...
	public void contributeToMenu(IMenuManager menuManager) {
		...
		IMenuManager submenuManager = new MenuManager(CwmEditorPlugin.INSTANCE.getString("_UI_SupervisedEditor_menu"), "CWM.SupervisedMenuID");
