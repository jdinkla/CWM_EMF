...
/**
 * This is the action bar contributor for the CWMComplete model editor.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class CWMCompleteActionBarContributor
	 ...
	 * @generated
	 */
	public CWMCompleteActionBarContributor() {
	...
	public void contributeToToolBar(IToolBarManager toolBarManager) {
		toolBarManager.add(new Separator("cwmcomplete-settings"));
		toolBarManager.add(new Separator("cwmcomplete-additions"));
	}
	...
	public void contributeToMenu(IMenuManager menuManager) {
		...
		IMenuManager submenuManager = new MenuManager(CwmEditorPlugin.INSTANCE.getString("_UI_CWMCompleteEditor_menu"), "CWM.CWMCompleteMenuID");
