...
/**
 * This is the action bar contributor for the Clustering model editor.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ClusteringActionBarContributor
	 ...
	 * @generated
	 */
	public ClusteringActionBarContributor() {
	...
	public void contributeToToolBar(IToolBarManager toolBarManager) {
		toolBarManager.add(new Separator("clustering-settings"));
		toolBarManager.add(new Separator("clustering-additions"));
	}
	...
	public void contributeToMenu(IMenuManager menuManager) {
		...
		IMenuManager submenuManager = new MenuManager(CwmEditorPlugin.INSTANCE.getString("_UI_ClusteringEditor_menu"), "CWM.ClusteringMenuID");
