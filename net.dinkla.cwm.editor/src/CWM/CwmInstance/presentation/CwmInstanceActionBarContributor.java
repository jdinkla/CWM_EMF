...
/**
 * This is the action bar contributor for the CwmInstance model editor.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class CwmInstanceActionBarContributor
	 ...
	 * @generated
	 */
	public CwmInstanceActionBarContributor() {
	...
	public void contributeToToolBar(IToolBarManager toolBarManager) {
		toolBarManager.add(new Separator("cwminstance-settings"));
		toolBarManager.add(new Separator("cwminstance-additions"));
	}
	...
	public void contributeToMenu(IMenuManager menuManager) {
		...
		IMenuManager submenuManager = new MenuManager(CwmEditorPlugin.INSTANCE.getString("_UI_CwmInstanceEditor_menu"), "CWM.CwmInstanceMenuID");
