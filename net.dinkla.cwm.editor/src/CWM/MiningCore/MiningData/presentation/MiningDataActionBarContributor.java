...
/**
 * This is the action bar contributor for the MiningData model editor.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class MiningDataActionBarContributor
	 ...
	 * @generated
	 */
	public MiningDataActionBarContributor() {
	...
	public void contributeToToolBar(IToolBarManager toolBarManager) {
		toolBarManager.add(new Separator("miningdata-settings"));
		toolBarManager.add(new Separator("miningdata-additions"));
	}
	...
	public void contributeToMenu(IMenuManager menuManager) {
		...
		IMenuManager submenuManager = new MenuManager(CwmEditorPlugin.INSTANCE.getString("_UI_MiningDataEditor_menu"), "CWM.MiningCore.MiningDataMenuID");
