...
/**
 * This is the action bar contributor for the MiningCore model editor.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class MiningCoreActionBarContributor
	 ...
	 * @generated
	 */
	public MiningCoreActionBarContributor() {
	...
	public void contributeToToolBar(IToolBarManager toolBarManager) {
		toolBarManager.add(new Separator("miningcore-settings"));
		toolBarManager.add(new Separator("miningcore-additions"));
	}
	...
	public void contributeToMenu(IMenuManager menuManager) {
		...
		IMenuManager submenuManager = new MenuManager(CwmEditorPlugin.INSTANCE.getString("_UI_MiningCoreEditor_menu"), "CWM.MiningCoreMenuID");
