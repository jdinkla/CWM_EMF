...
/**
 * This is the action bar contributor for the EntryPoint model editor.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class EntryPointActionBarContributor
	 ...
	 * @generated
	 */
	public EntryPointActionBarContributor() {
	...
	public void contributeToToolBar(IToolBarManager toolBarManager) {
		toolBarManager.add(new Separator("entrypoint-settings"));
		toolBarManager.add(new Separator("entrypoint-additions"));
	}
	...
	public void contributeToMenu(IMenuManager menuManager) {
		...
		IMenuManager submenuManager = new MenuManager(CwmEditorPlugin.INSTANCE.getString("_UI_EntryPointEditor_menu"), "CWM.MiningCore.EntryPointMenuID");
