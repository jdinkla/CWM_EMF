...
/**
 * This is the action bar contributor for the MiningResult model editor.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class MiningResultActionBarContributor
	 ...
	 * @generated
	 */
	public MiningResultActionBarContributor() {
	...
	public void contributeToToolBar(IToolBarManager toolBarManager) {
		toolBarManager.add(new Separator("miningresult-settings"));
		toolBarManager.add(new Separator("miningresult-additions"));
	}
	...
	public void contributeToMenu(IMenuManager menuManager) {
		...
		IMenuManager submenuManager = new MenuManager(CwmEditorPlugin.INSTANCE.getString("_UI_MiningResultEditor_menu"), "CWM.MiningCore.MiningResultMenuID");
