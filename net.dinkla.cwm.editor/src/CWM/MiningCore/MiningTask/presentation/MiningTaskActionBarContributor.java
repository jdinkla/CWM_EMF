...
/**
 * This is the action bar contributor for the MiningTask model editor.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class MiningTaskActionBarContributor
	 ...
	 * @generated
	 */
	public MiningTaskActionBarContributor() {
	...
	public void contributeToToolBar(IToolBarManager toolBarManager) {
		toolBarManager.add(new Separator("miningtask-settings"));
		toolBarManager.add(new Separator("miningtask-additions"));
	}
	...
	public void contributeToMenu(IMenuManager menuManager) {
		...
		IMenuManager submenuManager = new MenuManager(CwmEditorPlugin.INSTANCE.getString("_UI_MiningTaskEditor_menu"), "CWM.MiningCore.MiningTaskMenuID");
