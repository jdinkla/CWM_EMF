...
/**
 * This is the action bar contributor for the MiningModel model editor.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class MiningModelActionBarContributor
	 ...
	 * @generated
	 */
	public MiningModelActionBarContributor() {
	...
	public void contributeToToolBar(IToolBarManager toolBarManager) {
		toolBarManager.add(new Separator("miningmodel-settings"));
		toolBarManager.add(new Separator("miningmodel-additions"));
	}
	...
	public void contributeToMenu(IMenuManager menuManager) {
		...
		IMenuManager submenuManager = new MenuManager(CwmEditorPlugin.INSTANCE.getString("_UI_MiningModelEditor_menu"), "CWM.MiningCore.MiningModelMenuID");
