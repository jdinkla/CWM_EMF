...
/**
 * This is the action bar contributor for the CWM model editor.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class CWMActionBarContributor
	 ...
	 * @generated
	 */
	public CWMActionBarContributor() {
	...
	public void contributeToToolBar(IToolBarManager toolBarManager) {
		toolBarManager.add(new Separator("cwm-settings"));
		toolBarManager.add(new Separator("cwm-additions"));
	}
	...
	public void contributeToMenu(IMenuManager menuManager) {
		...
		IMenuManager submenuManager = new MenuManager(CwmEditorPlugin.INSTANCE.getString("_UI_CWMEditor_menu"), "CWMMenuID");
