...
/**
 * This is the action bar contributor for the Approximation model editor.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ApproximationActionBarContributor
	 ...
	 * @generated
	 */
	public ApproximationActionBarContributor() {
	...
	public void contributeToToolBar(IToolBarManager toolBarManager) {
		toolBarManager.add(new Separator("approximation-settings"));
		toolBarManager.add(new Separator("approximation-additions"));
	}
	...
	public void contributeToMenu(IMenuManager menuManager) {
		...
		IMenuManager submenuManager = new MenuManager(CwmEditorPlugin.INSTANCE.getString("_UI_ApproximationEditor_menu"), "CWM.ApproximationMenuID");
