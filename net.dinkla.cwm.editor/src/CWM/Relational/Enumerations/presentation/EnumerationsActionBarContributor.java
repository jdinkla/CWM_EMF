...
/**
 * This is the action bar contributor for the Enumerations model editor.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class EnumerationsActionBarContributor
	 ...
	 * @generated
	 */
	public EnumerationsActionBarContributor() {
	...
	public void contributeToToolBar(IToolBarManager toolBarManager) {
		toolBarManager.add(new Separator("enumerations-settings"));
		toolBarManager.add(new Separator("enumerations-additions"));
	}
	...
	public void contributeToMenu(IMenuManager menuManager) {
		...
		IMenuManager submenuManager = new MenuManager(CwmEditorPlugin.INSTANCE.getString("_UI_EnumerationsEditor_menu"), "CWM.Relational.EnumerationsMenuID");
