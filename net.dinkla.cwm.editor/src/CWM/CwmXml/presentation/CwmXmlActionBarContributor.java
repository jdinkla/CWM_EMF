...
/**
 * This is the action bar contributor for the CwmXml model editor.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class CwmXmlActionBarContributor
	 ...
	 * @generated
	 */
	public CwmXmlActionBarContributor() {
	...
	public void contributeToToolBar(IToolBarManager toolBarManager) {
		toolBarManager.add(new Separator("cwmxml-settings"));
		toolBarManager.add(new Separator("cwmxml-additions"));
	}
	...
	public void contributeToMenu(IMenuManager menuManager) {
		...
		IMenuManager submenuManager = new MenuManager(CwmEditorPlugin.INSTANCE.getString("_UI_CwmXmlEditor_menu"), "CWM.CwmXmlMenuID");
