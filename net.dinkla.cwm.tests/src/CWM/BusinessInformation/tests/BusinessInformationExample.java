...
/**
 * <!-- begin-user-doc -->
 * A sample utility for the '<em><b>BusinessInformation</b></em>' package.
 * <!-- end-user-doc -->
 * @generated
 */
public class BusinessInformationExample {
	/**
	 * <!-- begin-user-doc -->
	...
	public static void main(String[] args) {
		...
		if (args.length == 0) {
			...
			try {
				Resource resource = resourceSet.createResource(URI.createURI("http:///My.businessinformation"));
				ResponsibleParty root = BusinessInformationFactory.eINSTANCE.createResponsibleParty();
