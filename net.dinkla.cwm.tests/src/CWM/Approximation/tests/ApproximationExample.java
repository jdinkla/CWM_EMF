...
/**
 * <!-- begin-user-doc -->
 * A sample utility for the '<em><b>Approximation</b></em>' package.
 * <!-- end-user-doc -->
 * @generated
 */
public class ApproximationExample {
	...
	public static void main(String[] args) {
		...
		resourceSet.getPackageRegistry().put
			(ApproximationPackage.eNS_URI, 
			 ApproximationPackage.eINSTANCE);
		...
		if (args.length == 0) {
			...
			try {
				Resource resource = resourceSet.createResource(URI.createURI("http:///My.approximation"));
				ApproximationFunctionSettings root = ApproximationFactory.eINSTANCE.createApproximationFunctionSettings();
