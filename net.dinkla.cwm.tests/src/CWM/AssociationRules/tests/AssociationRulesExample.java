...
/**
 * <!-- begin-user-doc -->
 * A sample utility for the '<em><b>AssociationRules</b></em>' package.
 * <!-- end-user-doc -->
 * @generated
 */
public class AssociationRulesExample {
	...
	public static void main(String[] args) {
		...
		resourceSet.getPackageRegistry().put
			(AssociationRulesPackage.eNS_URI, 
			 AssociationRulesPackage.eINSTANCE);
		...
		if (args.length == 0) {
			...
			try {
				Resource resource = resourceSet.createResource(URI.createURI("http:///My.associationrules"));
				AssociationRulesFunctionSettings root = AssociationRulesFactory.eINSTANCE.createAssociationRulesFunctionSettings();
