...
/**
 * <!-- begin-user-doc -->
 * A sample utility for the '<em><b>Multidimensional</b></em>' package.
 * <!-- end-user-doc -->
 * @generated
 */
public class MultidimensionalExample {
	...
	public static void main(String[] args) {
		...
		resourceSet.getPackageRegistry().put
			(MultidimensionalPackage.eNS_URI, 
			 MultidimensionalPackage.eINSTANCE);
		...
		if (args.length == 0) {
			...
			try {
				Resource resource = resourceSet.createResource(URI.createURI("http:///My.multidimensional"));
				Dimension root = MultidimensionalFactory.eINSTANCE.createDimension();
