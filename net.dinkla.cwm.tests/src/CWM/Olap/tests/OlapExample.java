...
/**
 * <!-- begin-user-doc -->
 * A sample utility for the '<em><b>Olap</b></em>' package.
 * <!-- end-user-doc -->
 * @generated
 */
public class OlapExample {
	...
	public static void main(String[] args) {
		...
		if (args.length == 0) {
			...
			try {
				Resource resource = resourceSet.createResource(URI.createURI("http:///My.olap"));
				ContentMap root = OlapFactory.eINSTANCE.createContentMap();
