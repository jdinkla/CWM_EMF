...
/**
 * <!-- begin-user-doc -->
 * A sample utility for the '<em><b>EntryPoint</b></em>' package.
 * <!-- end-user-doc -->
 * @generated
 */
public class EntryPointExample {
	...
	public static void main(String[] args) {
		...
		resourceSet.getPackageRegistry().put
			(EntryPointPackage.eNS_URI, 
			 EntryPointPackage.eINSTANCE);
		...
		if (args.length == 0) {
			...
			try {
				Resource resource = resourceSet.createResource(URI.createURI("http:///My.entrypoint"));
				AuxiliaryObject root = EntryPointFactory.eINSTANCE.createAuxiliaryObject();
