...
/**
 * <!-- begin-user-doc -->
 * A sample utility for the '<em><b>TypeMapping</b></em>' package.
 * <!-- end-user-doc -->
 * @generated
 */
public class TypeMappingExample {
	...
	public static void main(String[] args) {
		...
		resourceSet.getPackageRegistry().put
			(TypeMappingPackage.eNS_URI, 
			 TypeMappingPackage.eINSTANCE);
		...
		if (args.length == 0) {
			...
			try {
				Resource resource = resourceSet.createResource(URI.createURI("http:///My.typemapping"));
				TypeMapping root = TypeMappingFactory.eINSTANCE.createTypeMapping();
