 ...
 * <ul>
 *   <li>{@link CWM.BusinessInformation.impl.DescriptionImpl#getBody <em>Body</em>}</li>
 *   <li>{@link CWM.BusinessInformation.impl.DescriptionImpl#getLanguage <em>Language</em>}</li>
 *   <li>{@link CWM.BusinessInformation.impl.DescriptionImpl#getType <em>Type</em>}</li>
 *   <li>{@link CWM.BusinessInformation.impl.DescriptionImpl#getModelElement <em>Model Element</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class DescriptionImpl extends NamespaceImpl implements Description {
	...
	public EList<ModelElement> getModelElement() {
		if (modelElement == null) {
			modelElement = new EObjectResolvingEList<ModelElement>(ModelElement.class, this, BusinessInformationPackage.DESCRIPTION__MODEL_ELEMENT);
		}
		return modelElement;
	}
