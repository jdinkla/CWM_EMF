...
public class BusinessInformationSwitch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case BusinessInformationPackage.BUSINESS_INFORMATION_CONTAINER: {
				BusinessInformation_container businessInformation_container = (BusinessInformation_container)theEObject;
				T result = caseBusinessInformation_container(businessInformation_container);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Business Information container</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Business Information container</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseBusinessInformation_container(BusinessInformation_container object) {
		return null;
	}
