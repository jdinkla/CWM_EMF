 ...
 * <ul>
 *   <li>{@link CWM.CwmInstance.impl.ObjectImpl#getSlot <em>Slot</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class ObjectImpl extends InstanceImpl implements CWM.CwmInstance.Object {
	/**
	...
	protected EClass eStaticClass() {
		return CwmInstancePackage.Literals.OBJECT;
	}
	...
	public EList<Slot> getSlot() {
		if (slot == null) {
			slot = new EObjectContainmentWithInverseEList<Slot>(Slot.class, this, CwmInstancePackage.OBJECT__SLOT, CwmInstancePackage.SLOT__OBJECT);
		}
		return slot;
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case CwmInstancePackage.OBJECT__SLOT:
