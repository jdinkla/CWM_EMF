 ...
 * <ul>
 *   <li>{@link CWM.CwmInstance.impl.InstanceImpl#getClassifier <em>Classifier</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public abstract class InstanceImpl extends ModelElementImpl implements Instance {
	...
	protected EClass eStaticClass() {
		return CwmInstancePackage.Literals.INSTANCE;
	}
		...
		if (classifier != null && classifier.eIsProxy()) {
			...
			if (classifier != oldClassifier) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, CwmInstancePackage.INSTANCE__CLASSIFIER, oldClassifier, classifier));
			}
		}
		return classifier;
	}
	...
	public void setClassifier(Classifier newClassifier) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CwmInstancePackage.INSTANCE__CLASSIFIER, oldClassifier, classifier));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case CwmInstancePackage.INSTANCE__CLASSIFIER:
