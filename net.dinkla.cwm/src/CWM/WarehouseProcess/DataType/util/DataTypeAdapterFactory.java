 ...
 * $Id$
 */
package CWM.WarehouseProcess.DataType.util;
...
public class DataTypeAdapterFactory extends AdapterFactoryImpl {
	...
	protected DataTypeSwitch<Adapter> modelSwitch =
		new DataTypeSwitch<Adapter>() {
			@Override
			public Adapter caseDataType_container(DataType_container object) {
				return createDataType_containerAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link CWM.WarehouseProcess.DataType.DataType_container <em>Data Type container</em>}'.
	 * <!-- begin-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createDataType_containerAdapter() {
		return null;
	}
