 ...
 * <!-- end-user-doc -->
 * @see CWM.WarehouseProcess.DataType.DataTypePackage#getDayOfWeek()
 * @model
 * @generated
 */
public enum DayOfWeek implements Enumerator {
	 ...
	 * @ordered
	 */
	WORKING_DAY(8, "workingDay", "workingDay"),
	 ...
	 * @ordered
	 */
	NONWORKING_DAY(9, "nonworkingDay", "nonworkingDay");
	 ...
	 * @ordered
	 */
	public static final int WORKING_DAY_VALUE = 8;
	 ...
	 * @ordered
	 */
	public static final int NONWORKING_DAY_VALUE = 9;
