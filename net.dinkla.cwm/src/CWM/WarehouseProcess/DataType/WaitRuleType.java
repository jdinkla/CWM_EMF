 ...
 * <!-- end-user-doc -->
 * @see CWM.WarehouseProcess.DataType.DataTypePackage#getWaitRuleType()
 * @model
 * @generated
 */
public enum WaitRuleType implements Enumerator {
	 ...
	 * @ordered
	 */
	WAIT_FOR_ALL(1, "waitForAll", "waitForAll"),
	 ...
	 * @ordered
	 */
	WAIT_FOR_ANY(2, "waitForAny", "waitForAny");
	 ...
	 * @ordered
	 */
	public static final int WAIT_FOR_ALL_VALUE = 1;
