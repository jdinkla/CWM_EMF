 ...
 * <!-- end-user-doc -->
 * @see CWM.WarehouseProcess.DataType.DataTypePackage#getRecurringType()
 * @model
 * @generated
 */
public enum RecurringType implements Enumerator {
	 ...
	 * @ordered
	 */
	EVERY_YEAR(1, "everyYear", "everyYear"),
	 ...
	 * @ordered
	 */
	EVERY_MONTH(2, "everyMonth", "everyMonth"),
	 ...
	 * @ordered
	 */
	EVERY_WEEK(3, "everyWeek", "everyWeek"),
	 ...
	 * @ordered
	 */
	EVERY_HOUR(5, "everyHour", "everyHour"),
	 ...
	 * @ordered
	 */
	EVERY_MINUTE(6, "everyMinute", "everyMinute");
	 ...
	 * @ordered
	 */
	public static final int EVERY_YEAR_VALUE = 1;
	 ...
	 * @ordered
	 */
	public static final int EVERY_DAY_VALUE = 4;
	 ...
	 * @ordered
	 */
	public static final int EVERY_HOUR_VALUE = 5;
	 ...
	 * @ordered
	 */
	public static final int EVERY_MINUTE_VALUE = 6;
