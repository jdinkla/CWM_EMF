...
public class EventsFactoryImpl extends EFactoryImpl implements EventsFactory {
	...
	public static EventsFactory init() {
		try {
			EventsFactory theEventsFactory = (EventsFactory)EPackage.Registry.INSTANCE.getEFactory("Events"); 
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			...
			case EventsPackage.EVENTS_CONTAINER: return createEvents_container();
			default:
	 ...
	 * @generated
	 */
	public Events_container createEvents_container() {
		Events_containerImpl events_container = new Events_containerImpl();
