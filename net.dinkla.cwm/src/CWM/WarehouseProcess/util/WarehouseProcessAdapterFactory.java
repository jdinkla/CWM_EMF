 ...
 * $Id$
 */
package CWM.WarehouseProcess.util;
...
public class WarehouseProcessAdapterFactory extends AdapterFactoryImpl {
	...
	protected WarehouseProcessSwitch<Adapter> modelSwitch =
		new WarehouseProcessSwitch<Adapter>() {
			...
			@Override
			public Adapter caseWarehouseProcess_container(WarehouseProcess_container object) {
				return createWarehouseProcess_containerAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link CWM.WarehouseProcess.WarehouseProcess <em>Warehouse Process</em>}'.
	 * <!-- begin-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link CWM.WarehouseProcess.WarehouseStep <em>Warehouse Step</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link CWM.WarehouseProcess.ProcessPackage <em>Process Package</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link CWM.WarehouseProcess.WarehouseActivity <em>Warehouse Activity</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link CWM.WarehouseProcess.WarehouseProcess_container <em>Warehouse Process container</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
