...
import CWM.Clustering.ClusteringModelCBasis;
...
public class ClusteringPackageImpl extends EPackageImpl implements ClusteringPackage {
	 ...
	 * @generated
	 */
	private EClass clusteringAttributeUsageEClass = null;
	 ...
	 * @generated
	 */
	private EClass clusteringFunctionSettingsEClass = null;
	 ...
	 * @generated
	 */
	private EClass clustering_containerEClass = null;
	 ...
	 * @generated
	 */
	private EEnum attributeComparisonFunctionEEnum = null;
	 ...
	 * @generated
	 */
	private EEnum clusteringModelCBasisEEnum = null;
	 ...
	 * @see CWM.Clustering.ClusteringPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	public static ClusteringPackage init() {
		...
		ClusteringPackageImpl theClusteringPackage = (ClusteringPackageImpl)(EPackage.Registry.INSTANCE.getEPackage(eNS_URI) instanceof ClusteringPackageImpl ? EPackage.Registry.INSTANCE.getEPackage(eNS_URI) : new ClusteringPackageImpl());
	 ...
	 * @generated
	 */
	public EClass getClusteringAttributeUsage() {
		return clusteringAttributeUsageEClass;
	}
	 ...
	 * @generated
	 */
	public EAttribute getClusteringAttributeUsage_AttributeComparisonFunction() {
		return (EAttribute)clusteringAttributeUsageEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public EAttribute getClusteringAttributeUsage_SimilarityScale() {
		return (EAttribute)clusteringAttributeUsageEClass.getEStructuralFeatures().get(1);
	}
	 ...
	 * @generated
	 */
	public EReference getClusteringAttributeUsage_ComparisonMatrix() {
		return (EReference)clusteringAttributeUsageEClass.getEStructuralFeatures().get(2);
	}
	 ...
	 * @generated
	 */
	public EClass getClusteringFunctionSettings() {
		return clusteringFunctionSettingsEClass;
	}
	 ...
	 * @generated
	 */
	public EAttribute getClusteringFunctionSettings_MaxNumberOfClusters() {
		return (EAttribute)clusteringFunctionSettingsEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public EAttribute getClusteringFunctionSettings_MinClusterSize() {
		return (EAttribute)clusteringFunctionSettingsEClass.getEStructuralFeatures().get(1);
	}
	 ...
	 * @generated
	 */
	public EAttribute getClusteringFunctionSettings_AggregationFunction() {
		return (EAttribute)clusteringFunctionSettingsEClass.getEStructuralFeatures().get(2);
	}
	 ...
	 * @generated
	 */
	public EClass getClustering_container() {
		return clustering_containerEClass;
	}
	 ...
	 * @generated
	 */
	public EReference getClustering_container_ClusteringAttributeUsage() {
		return (EReference)clustering_containerEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public EReference getClustering_container_ClusteringFunctionSettings() {
		return (EReference)clustering_containerEClass.getEStructuralFeatures().get(1);
	}
	 ...
	 * @generated
	 */
	public EEnum getAttributeComparisonFunction() {
		return attributeComparisonFunctionEEnum;
	}
	 ...
	 * @generated
	 */
	public EEnum getClusteringModelCBasis() {
		return clusteringModelCBasisEEnum;
	}
	...
	public void createPackageContents() {
		...
		clusteringAttributeUsageEClass = createEClass(CLUSTERING_ATTRIBUTE_USAGE);
		createEAttribute(clusteringAttributeUsageEClass, CLUSTERING_ATTRIBUTE_USAGE__ATTRIBUTE_COMPARISON_FUNCTION);
		createEAttribute(clusteringAttributeUsageEClass, CLUSTERING_ATTRIBUTE_USAGE__SIMILARITY_SCALE);
		createEReference(clusteringAttributeUsageEClass, CLUSTERING_ATTRIBUTE_USAGE__COMPARISON_MATRIX);

		clusteringFunctionSettingsEClass = createEClass(CLUSTERING_FUNCTION_SETTINGS);
		createEAttribute(clusteringFunctionSettingsEClass, CLUSTERING_FUNCTION_SETTINGS__MAX_NUMBER_OF_CLUSTERS);
		createEAttribute(clusteringFunctionSettingsEClass, CLUSTERING_FUNCTION_SETTINGS__MIN_CLUSTER_SIZE);
		createEAttribute(clusteringFunctionSettingsEClass, CLUSTERING_FUNCTION_SETTINGS__AGGREGATION_FUNCTION);

		clustering_containerEClass = createEClass(CLUSTERING_CONTAINER);
		createEReference(clustering_containerEClass, CLUSTERING_CONTAINER__CLUSTERING_ATTRIBUTE_USAGE);
		createEReference(clustering_containerEClass, CLUSTERING_CONTAINER__CLUSTERING_FUNCTION_SETTINGS);

		// Create enums
		aggregationFunctionEEnum = createEEnum(AGGREGATION_FUNCTION);
		attributeComparisonFunctionEEnum = createEEnum(ATTRIBUTE_COMPARISON_FUNCTION);
		clusteringModelCBasisEEnum = createEEnum(CLUSTERING_MODEL_CBASIS);
	}
	...
	public void initializePackageContents() {
		...
		clusteringAttributeUsageEClass.getESuperTypes().add(theMiningDataPackage.getAttributeUsage());
		clusteringFunctionSettingsEClass.getESuperTypes().add(theMiningFunctionSettingsPackage.getMiningFunctionSettings());

		// Initialize classes and features; add operations and parameters
		initEClass(clusteringAttributeUsageEClass, ClusteringAttributeUsage.class, "ClusteringAttributeUsage", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getClusteringAttributeUsage_AttributeComparisonFunction(), this.getAttributeComparisonFunction(), "attributeComparisonFunction", null, 0, 1, ClusteringAttributeUsage.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEAttribute(getClusteringAttributeUsage_SimilarityScale(), theMiningDataPackage.getDouble(), "similarityScale", null, 1, 1, ClusteringAttributeUsage.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEReference(getClusteringAttributeUsage_ComparisonMatrix(), theMiningDataPackage.getCategoryMatrix(), null, "comparisonMatrix", null, 0, 1, ClusteringAttributeUsage.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, !IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);

		initEClass(clusteringFunctionSettingsEClass, ClusteringFunctionSettings.class, "ClusteringFunctionSettings", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getClusteringFunctionSettings_MaxNumberOfClusters(), theCorePackage.getInteger(), "maxNumberOfClusters", null, 1, 1, ClusteringFunctionSettings.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEAttribute(getClusteringFunctionSettings_MinClusterSize(), theCorePackage.getInteger(), "minClusterSize", null, 1, 1, ClusteringFunctionSettings.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEAttribute(getClusteringFunctionSettings_AggregationFunction(), this.getAggregationFunction(), "aggregationFunction", null, 1, 1, ClusteringFunctionSettings.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);

		initEClass(clustering_containerEClass, Clustering_container.class, "Clustering_container", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getClustering_container_ClusteringAttributeUsage(), this.getClusteringAttributeUsage(), null, "ClusteringAttributeUsage", null, 0, -1, Clustering_container.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getClustering_container_ClusteringFunctionSettings(), this.getClusteringFunctionSettings(), null, "ClusteringFunctionSettings", null, 0, -1, Clustering_container.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		// Initialize enums and add enum literals
		initEEnum(aggregationFunctionEEnum, AggregationFunction.class, "AggregationFunction");
		addEEnumLiteral(aggregationFunctionEEnum, AggregationFunction.EUCLIDEAN);
		addEEnumLiteral(aggregationFunctionEEnum, AggregationFunction.SQUARED_EUCLIDEAN);
		addEEnumLiteral(aggregationFunctionEEnum, AggregationFunction.CHEBYCHEV);
		addEEnumLiteral(aggregationFunctionEEnum, AggregationFunction.CITY_BLOCK);
		addEEnumLiteral(aggregationFunctionEEnum, AggregationFunction.MINKOVSKI);
		addEEnumLiteral(aggregationFunctionEEnum, AggregationFunction.SIMPLE_MATCHING);
		addEEnumLiteral(aggregationFunctionEEnum, AggregationFunction.JACCARD);
		addEEnumLiteral(aggregationFunctionEEnum, AggregationFunction.TANIMOTO);
		addEEnumLiteral(aggregationFunctionEEnum, AggregationFunction.BINARY_SIMILARITY);

		initEEnum(attributeComparisonFunctionEEnum, AttributeComparisonFunction.class, "AttributeComparisonFunction");
		addEEnumLiteral(attributeComparisonFunctionEEnum, AttributeComparisonFunction.ABS_DIFF);
		addEEnumLiteral(attributeComparisonFunctionEEnum, AttributeComparisonFunction.GAUSS_SIM);
		addEEnumLiteral(attributeComparisonFunctionEEnum, AttributeComparisonFunction.DELTA);
		addEEnumLiteral(attributeComparisonFunctionEEnum, AttributeComparisonFunction.EQUAL);
		addEEnumLiteral(attributeComparisonFunctionEEnum, AttributeComparisonFunction.TABLE);

		initEEnum(clusteringModelCBasisEEnum, ClusteringModelCBasis.class, "ClusteringModelCBasis");
		addEEnumLiteral(clusteringModelCBasisEEnum, ClusteringModelCBasis.CENTER_BASED);
		addEEnumLiteral(clusteringModelCBasisEEnum, ClusteringModelCBasis.PROBABILITY_BASED);
		addEEnumLiteral(clusteringModelCBasisEEnum, ClusteringModelCBasis.PARTITION_BASED);
		addEEnumLiteral(clusteringModelCBasisEEnum, ClusteringModelCBasis.AGGREGATION_BASED);
	}
