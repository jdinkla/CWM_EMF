...
public class SoftwareDeploymentSwitch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case SoftwareDeploymentPackage.SOFTWARE_DEPLOYMENT_CONTAINER: {
				SoftwareDeployment_container softwareDeployment_container = (SoftwareDeployment_container)theEObject;
				T result = caseSoftwareDeployment_container(softwareDeployment_container);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Software Deployment container</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Software Deployment container</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseSoftwareDeployment_container(SoftwareDeployment_container object) {
		return null;
	}
