...
public class CoreSwitch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case CorePackage.CLASS: {
				CWM.Core.Class class_ = (CWM.Core.Class)theEObject;
			...
			case CorePackage.PACKAGE: {
				CWM.Core.Package package_ = (CWM.Core.Package)theEObject;
			...
			case CorePackage.CORE_CONTAINER: {
				Core_container core_container = (Core_container)theEObject;
				T result = caseCore_container(core_container);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Core container</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Core container</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseCore_container(Core_container object) {
		return null;
	}
