 ...
 * <ul>
 *   <li>{@link CWM.Core.impl.DependencyImpl#getKind <em>Kind</em>}</li>
 *   <li>{@link CWM.Core.impl.DependencyImpl#getClient <em>Client</em>}</li>
 *   <li>{@link CWM.Core.impl.DependencyImpl#getSupplier <em>Supplier</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class DependencyImpl extends ModelElementImpl implements Dependency {
	...
	public EList<ModelElement> getSupplier() {
		if (supplier == null) {
			supplier = new EObjectResolvingEList<ModelElement>(ModelElement.class, this, CorePackage.DEPENDENCY__SUPPLIER);
		}
		return supplier;
	}
