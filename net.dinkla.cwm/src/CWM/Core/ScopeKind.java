 ...
 * <!-- end-user-doc -->
 * @see CWM.Core.CorePackage#getScopeKind()
 * @model
 * @generated
 */
public enum ScopeKind implements Enumerator {
	 ...
	 * @ordered
	 */
	SK_INSTANCE(1, "sk_instance", "sk_instance"),
	 ...
	 * @ordered
	 */
	SK_CLASSIFIER(2, "sk_classifier", "sk_classifier");
	 ...
	 * @ordered
	 */
	public static final int SK_INSTANCE_VALUE = 1;
	 ...
	 * @ordered
	 */
	public static final int SK_CLASSIFIER_VALUE = 2;
