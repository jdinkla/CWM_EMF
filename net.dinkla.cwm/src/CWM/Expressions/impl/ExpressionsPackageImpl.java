...
public class ExpressionsPackageImpl extends EPackageImpl implements ExpressionsPackage {
	 ...
	 * @generated
	 */
	private EClass expressions_containerEClass = null;
	 ...
	 * @see CWM.Expressions.ExpressionsPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	 ...
	 * @generated
	 */
	public EClass getExpressions_container() {
		return expressions_containerEClass;
	}
	 ...
	 * @generated
	 */
	public EReference getExpressions_container_ExpressionNode() {
		return (EReference)expressions_containerEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public EReference getExpressions_container_ConstantNode() {
		return (EReference)expressions_containerEClass.getEStructuralFeatures().get(1);
	}
	 ...
	 * @generated
	 */
	public EReference getExpressions_container_ElementNode() {
		return (EReference)expressions_containerEClass.getEStructuralFeatures().get(2);
	}
	 ...
	 * @generated
	 */
	public EReference getExpressions_container_FeatureNode() {
		return (EReference)expressions_containerEClass.getEStructuralFeatures().get(3);
	}
	...
	public void createPackageContents() {
		...
		expressions_containerEClass = createEClass(EXPRESSIONS_CONTAINER);
		createEReference(expressions_containerEClass, EXPRESSIONS_CONTAINER__EXPRESSION_NODE);
		createEReference(expressions_containerEClass, EXPRESSIONS_CONTAINER__CONSTANT_NODE);
		createEReference(expressions_containerEClass, EXPRESSIONS_CONTAINER__ELEMENT_NODE);
		createEReference(expressions_containerEClass, EXPRESSIONS_CONTAINER__FEATURE_NODE);
	}
	...
	public void initializePackageContents() {
		...
		initEReference(getExpressionNode_Type(), theCorePackage.getClassifier(), null, "type", null, 0, 1, ExpressionNode.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, !IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);

		initEClass(constantNodeEClass, ConstantNode.class, "ConstantNode", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getConstantNode_Value(), theCorePackage.getAny(), "value", null, 1, 1, ConstantNode.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);

		initEClass(elementNodeEClass, ElementNode.class, "ElementNode", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getElementNode_ModelElement(), theCorePackage.getModelElement(), null, "modelElement", null, 1, 1, ElementNode.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, !IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		...
		initEReference(getFeatureNode_Feature(), theCorePackage.getFeature(), null, "feature", null, 1, 1, FeatureNode.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, !IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);

		initEClass(expressions_containerEClass, Expressions_container.class, "Expressions_container", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getExpressions_container_ExpressionNode(), this.getExpressionNode(), null, "ExpressionNode", null, 0, -1, Expressions_container.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getExpressions_container_ConstantNode(), this.getConstantNode(), null, "ConstantNode", null, 0, -1, Expressions_container.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getExpressions_container_ElementNode(), this.getElementNode(), null, "ElementNode", null, 0, -1, Expressions_container.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getExpressions_container_FeatureNode(), this.getFeatureNode(), null, "FeatureNode", null, 0, -1, Expressions_container.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
	}
