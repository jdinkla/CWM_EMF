...
import CWM.Core.impl.ElementImpl;
 ...
 * <ul>
 *   <li>{@link CWM.Expressions.impl.ExpressionNodeImpl#getExpression <em>Expression</em>}</li>
 *   <li>{@link CWM.Expressions.impl.ExpressionNodeImpl#getFeatureNode <em>Feature Node</em>}</li>
 *   <li>{@link CWM.Expressions.impl.ExpressionNodeImpl#getType <em>Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ExpressionNodeImpl extends ElementImpl implements ExpressionNode {
	...
	public void setType(Classifier newType) {
		...
		type = newType;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ExpressionsPackage.EXPRESSION_NODE__TYPE, oldType, type));
	}
