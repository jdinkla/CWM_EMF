...
public class DataTypesPackageImpl extends EPackageImpl implements DataTypesPackage {
	 ...
	 * @generated
	 */
	private EClass dataTypes_containerEClass = null;
	 ...
	 * @see CWM.DataTypes.DataTypesPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	 ...
	 * @generated
	 */
	public EClass getDataTypes_container() {
		return dataTypes_containerEClass;
	}
	 ...
	 * @generated
	 */
	public EReference getDataTypes_container_Enumeration() {
		return (EReference)dataTypes_containerEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public EReference getDataTypes_container_EnumerationLiteral() {
		return (EReference)dataTypes_containerEClass.getEStructuralFeatures().get(1);
	}
	 ...
	 * @generated
	 */
	public EReference getDataTypes_container_QueryExpression() {
		return (EReference)dataTypes_containerEClass.getEStructuralFeatures().get(2);
	}
	 ...
	 * @generated
	 */
	public EReference getDataTypes_container_TypeAlias() {
		return (EReference)dataTypes_containerEClass.getEStructuralFeatures().get(3);
	}
	 ...
	 * @generated
	 */
	public EReference getDataTypes_container_Union() {
		return (EReference)dataTypes_containerEClass.getEStructuralFeatures().get(4);
	}
	 ...
	 * @generated
	 */
	public EReference getDataTypes_container_UnionMember() {
		return (EReference)dataTypes_containerEClass.getEStructuralFeatures().get(5);
	}
	...
	public void createPackageContents() {
		...
		dataTypes_containerEClass = createEClass(DATA_TYPES_CONTAINER);
		createEReference(dataTypes_containerEClass, DATA_TYPES_CONTAINER__ENUMERATION);
		createEReference(dataTypes_containerEClass, DATA_TYPES_CONTAINER__ENUMERATION_LITERAL);
		createEReference(dataTypes_containerEClass, DATA_TYPES_CONTAINER__QUERY_EXPRESSION);
		createEReference(dataTypes_containerEClass, DATA_TYPES_CONTAINER__TYPE_ALIAS);
		createEReference(dataTypes_containerEClass, DATA_TYPES_CONTAINER__UNION);
		createEReference(dataTypes_containerEClass, DATA_TYPES_CONTAINER__UNION_MEMBER);
	}
	...
	public void initializePackageContents() {
		...
		initEAttribute(getEnumeration_IsOrdered(), theCorePackage.getBoolean(), "isOrdered", null, 1, 1, Enumeration.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		...
		initEReference(getTypeAlias_Type(), theCorePackage.getClassifier(), null, "type", null, 1, 1, TypeAlias.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, !IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);

		initEClass(unionEClass, Union.class, "Union", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getUnion_Discriminator(), theCorePackage.getStructuralFeature(), null, "discriminator", null, 0, 1, Union.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, !IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);

		initEClass(unionMemberEClass, UnionMember.class, "UnionMember", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getUnionMember_MemberCase(), theCorePackage.getExpression(), null, "memberCase", null, 1, 1, UnionMember.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, !IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEAttribute(getUnionMember_IsDefault(), theCorePackage.getBoolean(), "isDefault", null, 1, 1, UnionMember.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);

		initEClass(dataTypes_containerEClass, DataTypes_container.class, "DataTypes_container", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getDataTypes_container_Enumeration(), this.getEnumeration(), null, "Enumeration", null, 0, -1, DataTypes_container.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getDataTypes_container_EnumerationLiteral(), this.getEnumerationLiteral(), null, "EnumerationLiteral", null, 0, -1, DataTypes_container.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getDataTypes_container_QueryExpression(), this.getQueryExpression(), null, "QueryExpression", null, 0, -1, DataTypes_container.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getDataTypes_container_TypeAlias(), this.getTypeAlias(), null, "TypeAlias", null, 0, -1, DataTypes_container.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getDataTypes_container_Union(), this.getUnion(), null, "Union", null, 0, -1, DataTypes_container.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getDataTypes_container_UnionMember(), this.getUnionMember(), null, "UnionMember", null, 0, -1, DataTypes_container.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
	}
