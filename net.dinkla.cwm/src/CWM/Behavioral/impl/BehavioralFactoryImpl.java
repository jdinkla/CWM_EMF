...
public class BehavioralFactoryImpl extends EFactoryImpl implements BehavioralFactory {
	...
	public static BehavioralFactory init() {
		try {
			BehavioralFactory theBehavioralFactory = (BehavioralFactory)EPackage.Registry.INSTANCE.getEFactory("Behavioral"); 
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			...
			case BehavioralPackage.BEHAVIORAL_CONTAINER: return createBehavioral_container();
			default:
	 ...
	 * @generated
	 */
	public Behavioral_container createBehavioral_container() {
		Behavioral_containerImpl behavioral_container = new Behavioral_containerImpl();
		return behavioral_container;
	}
