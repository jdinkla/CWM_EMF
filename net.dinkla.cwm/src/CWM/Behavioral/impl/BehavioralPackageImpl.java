...
import CWM.Behavioral.ParameterDirectionKind;
...
public class BehavioralPackageImpl extends EPackageImpl implements BehavioralPackage {
	 ...
	 * @generated
	 */
	private EClass behavioral_containerEClass = null;
	 ...
	 * @see CWM.Behavioral.BehavioralPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	 ...
	 * @generated
	 */
	public EClass getBehavioral_container() {
		return behavioral_containerEClass;
	}
	 ...
	 * @generated
	 */
	public EReference getBehavioral_container_Argument() {
		return (EReference)behavioral_containerEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public EReference getBehavioral_container_BehavioralFeature() {
		return (EReference)behavioral_containerEClass.getEStructuralFeatures().get(1);
	}
	 ...
	 * @generated
	 */
	public EReference getBehavioral_container_CallAction() {
		return (EReference)behavioral_containerEClass.getEStructuralFeatures().get(2);
	}
	 ...
	 * @generated
	 */
	public EReference getBehavioral_container_Event() {
		return (EReference)behavioral_containerEClass.getEStructuralFeatures().get(3);
	}
	 ...
	 * @generated
	 */
	public EReference getBehavioral_container_Interface() {
		return (EReference)behavioral_containerEClass.getEStructuralFeatures().get(4);
	}
	 ...
	 * @generated
	 */
	public EReference getBehavioral_container_Method() {
		return (EReference)behavioral_containerEClass.getEStructuralFeatures().get(5);
	}
	 ...
	 * @generated
	 */
	public EReference getBehavioral_container_Operation() {
		return (EReference)behavioral_containerEClass.getEStructuralFeatures().get(6);
	}
	 ...
	 * @generated
	 */
	public EReference getBehavioral_container_Parameter() {
		return (EReference)behavioral_containerEClass.getEStructuralFeatures().get(7);
	}
	...
	public void createPackageContents() {
		...
		behavioral_containerEClass = createEClass(BEHAVIORAL_CONTAINER);
		createEReference(behavioral_containerEClass, BEHAVIORAL_CONTAINER__ARGUMENT);
		createEReference(behavioral_containerEClass, BEHAVIORAL_CONTAINER__BEHAVIORAL_FEATURE);
		createEReference(behavioral_containerEClass, BEHAVIORAL_CONTAINER__CALL_ACTION);
		createEReference(behavioral_containerEClass, BEHAVIORAL_CONTAINER__EVENT);
		createEReference(behavioral_containerEClass, BEHAVIORAL_CONTAINER__INTERFACE);
		createEReference(behavioral_containerEClass, BEHAVIORAL_CONTAINER__METHOD);
		createEReference(behavioral_containerEClass, BEHAVIORAL_CONTAINER__OPERATION);
		createEReference(behavioral_containerEClass, BEHAVIORAL_CONTAINER__PARAMETER);
	...
	public void initializePackageContents() {
		...
		initEReference(getArgument_Value(), theCorePackage.getExpression(), null, "value", null, 1, 1, Argument.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, !IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		...
		initEAttribute(getBehavioralFeature_IsQuery(), theCorePackage.getBoolean(), "isQuery", null, 1, 1, BehavioralFeature.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		...
		initEReference(getCallAction_Operation(), this.getOperation(), null, "operation", null, 1, 1, CallAction.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, !IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		...
		initEReference(getMethod_Body(), theCorePackage.getProcedureExpression(), null, "body", null, 1, 1, Method.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, !IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		...
		initEAttribute(getOperation_IsAbstract(), theCorePackage.getBoolean(), "isAbstract", null, 1, 1, Operation.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		...
		initEAttribute(getParameter_Kind(), this.getParameterDirectionKind(), "kind", null, 1, 1, Parameter.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		...
		initEReference(getParameter_Type(), theCorePackage.getClassifier(), null, "type", null, 1, 1, Parameter.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, !IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);

		initEClass(behavioral_containerEClass, Behavioral_container.class, "Behavioral_container", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getBehavioral_container_Argument(), this.getArgument(), null, "Argument", null, 0, -1, Behavioral_container.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getBehavioral_container_BehavioralFeature(), this.getBehavioralFeature(), null, "BehavioralFeature", null, 0, -1, Behavioral_container.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getBehavioral_container_CallAction(), this.getCallAction(), null, "CallAction", null, 0, -1, Behavioral_container.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getBehavioral_container_Event(), this.getEvent(), null, "Event", null, 0, -1, Behavioral_container.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getBehavioral_container_Interface(), this.getInterface(), null, "Interface", null, 0, -1, Behavioral_container.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getBehavioral_container_Method(), this.getMethod(), null, "Method", null, 0, -1, Behavioral_container.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getBehavioral_container_Operation(), this.getOperation(), null, "Operation", null, 0, -1, Behavioral_container.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getBehavioral_container_Parameter(), this.getParameter(), null, "Parameter", null, 0, -1, Behavioral_container.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
