 ...
 * <ul>
 *   <li>{@link CWM.Behavioral.impl.ParameterImpl#getDefaultValue <em>Default Value</em>}</li>
 *   <li>{@link CWM.Behavioral.impl.ParameterImpl#getKind <em>Kind</em>}</li>
 *   <li>{@link CWM.Behavioral.impl.ParameterImpl#getBehavioralFeature <em>Behavioral Feature</em>}</li>
 *   <li>{@link CWM.Behavioral.impl.ParameterImpl#getEvent <em>Event</em>}</li>
 *   <li>{@link CWM.Behavioral.impl.ParameterImpl#getType <em>Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ParameterImpl extends ModelElementImpl implements Parameter {
	...
	public void setType(Classifier newType) {
		...
		type = newType;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BehavioralPackage.PARAMETER__TYPE, oldType, type));
	}
