...
public class TypeMappingAdapterFactory extends AdapterFactoryImpl {
	...
	protected TypeMappingSwitch<Adapter> modelSwitch =
		new TypeMappingSwitch<Adapter>() {
			...
			@Override
			public Adapter caseTypeMapping_container(TypeMapping_container object) {
				return createTypeMapping_containerAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link CWM.TypeMapping.TypeMapping <em>Type Mapping</em>}'.
	 * <!-- begin-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link CWM.TypeMapping.TypeSystem <em>Type System</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link CWM.TypeMapping.TypeMapping_container <em>Type Mapping container</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
