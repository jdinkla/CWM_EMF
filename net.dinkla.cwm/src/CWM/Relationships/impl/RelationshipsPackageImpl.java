...
public class RelationshipsPackageImpl extends EPackageImpl implements RelationshipsPackage {
	 ...
	 * @generated
	 */
	private EClass relationships_containerEClass = null;
	 ...
	 * @see CWM.Relationships.RelationshipsPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	 ...
	 * @generated
	 */
	public EClass getRelationships_container() {
		return relationships_containerEClass;
	}
	 ...
	 * @generated
	 */
	public EReference getRelationships_container_Association() {
		return (EReference)relationships_containerEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public EReference getRelationships_container_AssociationEnd() {
		return (EReference)relationships_containerEClass.getEStructuralFeatures().get(1);
	}
	 ...
	 * @generated
	 */
	public EReference getRelationships_container_Generalization() {
		return (EReference)relationships_containerEClass.getEStructuralFeatures().get(2);
	}
	...
	public void createPackageContents() {
		...
		relationships_containerEClass = createEClass(RELATIONSHIPS_CONTAINER);
		createEReference(relationships_containerEClass, RELATIONSHIPS_CONTAINER__ASSOCIATION);
		createEReference(relationships_containerEClass, RELATIONSHIPS_CONTAINER__ASSOCIATION_END);
		createEReference(relationships_containerEClass, RELATIONSHIPS_CONTAINER__GENERALIZATION);
	...
	public void initializePackageContents() {
		...
		initEAttribute(getAssociationEnd_IsNavigable(), theCorePackage.getBoolean(), "isNavigable", null, 1, 1, AssociationEnd.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);

		initEClass(generalizationEClass, Generalization.class, "Generalization", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getGeneralization_Child(), theCorePackage.getClassifier(), null, "child", null, 1, 1, Generalization.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, !IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEReference(getGeneralization_Parent(), theCorePackage.getClassifier(), null, "parent", null, 1, 1, Generalization.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, !IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);

		initEClass(relationships_containerEClass, Relationships_container.class, "Relationships_container", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getRelationships_container_Association(), this.getAssociation(), null, "Association", null, 0, -1, Relationships_container.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getRelationships_container_AssociationEnd(), this.getAssociationEnd(), null, "AssociationEnd", null, 0, -1, Relationships_container.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getRelationships_container_Generalization(), this.getGeneralization(), null, "Generalization", null, 0, -1, Relationships_container.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
