...
public class RelationshipsFactoryImpl extends EFactoryImpl implements RelationshipsFactory {
	...
	public static RelationshipsFactory init() {
		try {
			RelationshipsFactory theRelationshipsFactory = (RelationshipsFactory)EPackage.Registry.INSTANCE.getEFactory("Relationships"); 
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			...
			case RelationshipsPackage.RELATIONSHIPS_CONTAINER: return createRelationships_container();
			default:
	 ...
	 * @generated
	 */
	public Relationships_container createRelationships_container() {
		Relationships_containerImpl relationships_container = new Relationships_containerImpl();
		return relationships_container;
	}
