 ...
 * @generated
 */
public class CWMCompletePackageImpl extends EPackageImpl implements CWMCompletePackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	private EClass cwmComplete_containerEClass = null;
	 ...
	 * @see CWM.CWMComplete.CWMCompletePackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private CWMCompletePackageImpl() {
		super(eNS_URI, CWMCompleteFactory.eINSTANCE);
	}
	 ...
	 * @generated
	 */
	public static CWMCompletePackage init() {
		if (isInited) return (CWMCompletePackage)EPackage.Registry.INSTANCE.getEPackage(CWMCompletePackage.eNS_URI);

		// Obtain or create and register package
		CWMCompletePackageImpl theCWMCompletePackage = (CWMCompletePackageImpl)(EPackage.Registry.INSTANCE.getEPackage(eNS_URI) instanceof CWMCompletePackageImpl ? EPackage.Registry.INSTANCE.getEPackage(eNS_URI) : new CWMCompletePackageImpl());
		...
		theCWMCompletePackage.freeze();

		return theCWMCompletePackage;
	}
	 ...
	 * @generated
	 */
	public EClass getCWMComplete_container() {
		return cwmComplete_containerEClass;
	}
	 ...
	 * @generated
	 */
	public CWMCompleteFactory getCWMCompleteFactory() {
		return (CWMCompleteFactory)getEFactoryInstance();
	}
	...
	public void createPackageContents() {
		...
		cwmComplete_containerEClass = createEClass(CWM_COMPLETE_CONTAINER);
	}
	...
	public void initializePackageContents() {
		...
		initEClass(cwmComplete_containerEClass, CWMComplete_container.class, "CWMComplete_container", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
	}

} //CWMCompletePackageImpl
