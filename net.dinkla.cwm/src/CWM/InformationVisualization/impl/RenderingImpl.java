 ...
 * <ul>
 *   <li>{@link CWM.InformationVisualization.impl.RenderingImpl#getFormula <em>Formula</em>}</li>
 *   <li>{@link CWM.InformationVisualization.impl.RenderingImpl#getAction <em>Action</em>}</li>
 *   <li>{@link CWM.InformationVisualization.impl.RenderingImpl#getFileName <em>File Name</em>}</li>
 *   <li>{@link CWM.InformationVisualization.impl.RenderingImpl#getType <em>Type</em>}</li>
 *   <li>{@link CWM.InformationVisualization.impl.RenderingImpl#getUrl <em>Url</em>}</li>
 *   <li>{@link CWM.InformationVisualization.impl.RenderingImpl#getRenderedObject <em>Rendered Object</em>}</li>
 *   <li>{@link CWM.InformationVisualization.impl.RenderingImpl#getDefaultedRenderedObject <em>Defaulted Rendered Object</em>}</li>
 *   <li>{@link CWM.InformationVisualization.impl.RenderingImpl#getRenderedObjectSet <em>Rendered Object Set</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class RenderingImpl extends FeatureImpl implements Rendering {
	...
	public EList<RenderedObject> getRenderedObject() {
		if (renderedObject == null) {
			renderedObject = new EObjectWithInverseResolvingEList.ManyInverse<RenderedObject>(RenderedObject.class, this, InformationVisualizationPackage.RENDERING__RENDERED_OBJECT, InformationVisualizationPackage.RENDERED_OBJECT__RENDERING);
		}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case InformationVisualizationPackage.RENDERING__RENDERED_OBJECT:
