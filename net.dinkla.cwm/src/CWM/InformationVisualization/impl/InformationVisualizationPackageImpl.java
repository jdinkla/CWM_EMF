...
public class InformationVisualizationPackageImpl extends EPackageImpl implements InformationVisualizationPackage {
	 ...
	 * @generated
	 */
	private EClass informationVisualization_containerEClass = null;
	 ...
	 * @see CWM.InformationVisualization.InformationVisualizationPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	 ...
	 * @generated
	 */
	public EReference getRenderedObject_Rendering() {
	...
	public EReference getRenderedObject_ModelElement() {
		return (EReference)renderedObjectEClass.getEStructuralFeatures().get(11);
	}
	 ...
	 * @generated
	 */
	public EReference getRenderedObject_RenderedObjectSet() {
		return (EReference)renderedObjectEClass.getEStructuralFeatures().get(12);
	}
	 ...
	 * @generated
	 */
	public EReference getRenderedObjectSet_RenderedObject() {
	...
	public EReference getRenderedObjectSet_Rendering() {
		return (EReference)renderedObjectSetEClass.getEStructuralFeatures().get(1);
	}
	 ...
	 * @generated
	 */
	public EReference getRendering_RenderedObject() {
	...
	public EReference getRendering_RenderedObjectSet() {
		return (EReference)renderingEClass.getEStructuralFeatures().get(7);
	}
	 ...
	 * @generated
	 */
	public EClass getInformationVisualization_container() {
		return informationVisualization_containerEClass;
	}
	 ...
	 * @generated
	 */
	public EReference getInformationVisualization_container_RenderedObject() {
		return (EReference)informationVisualization_containerEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public EReference getInformationVisualization_container_RenderedObjectSet() {
		return (EReference)informationVisualization_containerEClass.getEStructuralFeatures().get(1);
	}
	 ...
	 * @generated
	 */
	public EReference getInformationVisualization_container_Rendering() {
		return (EReference)informationVisualization_containerEClass.getEStructuralFeatures().get(2);
	}
	 ...
	 * @generated
	 */
	public EReference getInformationVisualization_container_XSLRendering() {
		return (EReference)informationVisualization_containerEClass.getEStructuralFeatures().get(3);
	}
	...
	public void createPackageContents() {
		...
		createEReference(renderedObjectEClass, RENDERED_OBJECT__RENDERING);
		...
		createEReference(renderedObjectEClass, RENDERED_OBJECT__RENDERED_OBJECT_SET);

		renderedObjectSetEClass = createEClass(RENDERED_OBJECT_SET);
		createEReference(renderedObjectSetEClass, RENDERED_OBJECT_SET__RENDERED_OBJECT);
		...
		createEReference(renderingEClass, RENDERING__RENDERED_OBJECT);
		...
		informationVisualization_containerEClass = createEClass(INFORMATION_VISUALIZATION_CONTAINER);
		createEReference(informationVisualization_containerEClass, INFORMATION_VISUALIZATION_CONTAINER__RENDERED_OBJECT);
		createEReference(informationVisualization_containerEClass, INFORMATION_VISUALIZATION_CONTAINER__RENDERED_OBJECT_SET);
		createEReference(informationVisualization_containerEClass, INFORMATION_VISUALIZATION_CONTAINER__RENDERING);
		createEReference(informationVisualization_containerEClass, INFORMATION_VISUALIZATION_CONTAINER__XSL_RENDERING);
	}
	...
	public void initializePackageContents() {
		...
		initEReference(getRenderedObject_Formula(), theExpressionsPackage.getExpressionNode(), null, "formula", null, 1, 1, RenderedObject.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, !IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEAttribute(getRenderedObject_Action(), theCorePackage.getString(), "action", null, 1, 1, RenderedObject.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEAttribute(getRenderedObject_FileName(), theCorePackage.getString(), "fileName", null, 1, 1, RenderedObject.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEAttribute(getRenderedObject_Type(), theCorePackage.getString(), "type", null, 1, 1, RenderedObject.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEAttribute(getRenderedObject_Url(), theCorePackage.getString(), "url", null, 1, 1, RenderedObject.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEReference(getRenderedObject_Rendering(), this.getRendering(), this.getRendering_RenderedObject(), "rendering", null, 0, -1, RenderedObject.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		...
		initEReference(getRenderedObject_ModelElement(), theCorePackage.getModelElement(), null, "modelElement", null, 0, 1, RenderedObject.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, !IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEReference(getRenderedObject_RenderedObjectSet(), this.getRenderedObjectSet(), this.getRenderedObjectSet_RenderedObject(), "renderedObjectSet", null, 1, 1, RenderedObject.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, !IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		...
		initEReference(getRenderedObjectSet_RenderedObject(), this.getRenderedObject(), this.getRenderedObject_RenderedObjectSet(), "renderedObject", null, 0, -1, RenderedObjectSet.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		...
		initEReference(getRendering_Formula(), theExpressionsPackage.getExpressionNode(), null, "formula", null, 1, 1, Rendering.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, !IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEAttribute(getRendering_Action(), theCorePackage.getString(), "action", null, 1, 1, Rendering.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEAttribute(getRendering_FileName(), theCorePackage.getString(), "fileName", null, 1, 1, Rendering.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEAttribute(getRendering_Type(), theCorePackage.getString(), "type", null, 1, 1, Rendering.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEAttribute(getRendering_Url(), theCorePackage.getString(), "url", null, 1, 1, Rendering.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEReference(getRendering_RenderedObject(), this.getRenderedObject(), this.getRenderedObject_Rendering(), "renderedObject", null, 0, -1, Rendering.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		...
		initEClass(informationVisualization_containerEClass, InformationVisualization_container.class, "InformationVisualization_container", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getInformationVisualization_container_RenderedObject(), this.getRenderedObject(), null, "RenderedObject", null, 0, -1, InformationVisualization_container.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getInformationVisualization_container_RenderedObjectSet(), this.getRenderedObjectSet(), null, "RenderedObjectSet", null, 0, -1, InformationVisualization_container.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getInformationVisualization_container_Rendering(), this.getRendering(), null, "Rendering", null, 0, -1, InformationVisualization_container.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getInformationVisualization_container_XSLRendering(), this.getXSLRendering(), null, "XSLRendering", null, 0, -1, InformationVisualization_container.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
	}
