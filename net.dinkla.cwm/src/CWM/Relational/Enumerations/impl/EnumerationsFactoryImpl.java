...
public class EnumerationsFactoryImpl extends EFactoryImpl implements EnumerationsFactory {
	...
	public static EnumerationsFactory init() {
		try {
			EnumerationsFactory theEnumerationsFactory = (EnumerationsFactory)EPackage.Registry.INSTANCE.getEFactory("Enumerations"); 
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			case EnumerationsPackage.ENUMERATIONS_CONTAINER: return createEnumerations_container();
			default:
	 ...
	 * @generated
	 */
	public Enumerations_container createEnumerations_container() {
		Enumerations_containerImpl enumerations_container = new Enumerations_containerImpl();
		return enumerations_container;
	}
