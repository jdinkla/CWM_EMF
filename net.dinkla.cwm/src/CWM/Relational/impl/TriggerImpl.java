 ...
 * <ul>
 *   <li>{@link CWM.Relational.impl.TriggerImpl#getEventManipulation <em>Event Manipulation</em>}</li>
 *   <li>{@link CWM.Relational.impl.TriggerImpl#getActionCondition <em>Action Condition</em>}</li>
 *   <li>{@link CWM.Relational.impl.TriggerImpl#getActionStatement <em>Action Statement</em>}</li>
 *   <li>{@link CWM.Relational.impl.TriggerImpl#getActionOrientation <em>Action Orientation</em>}</li>
 *   <li>{@link CWM.Relational.impl.TriggerImpl#getConditionTiming <em>Condition Timing</em>}</li>
 *   <li>{@link CWM.Relational.impl.TriggerImpl#getConditionReferenceNewTable <em>Condition Reference New Table</em>}</li>
 *   <li>{@link CWM.Relational.impl.TriggerImpl#getConditionReferenceOldTable <em>Condition Reference Old Table</em>}</li>
 *   <li>{@link CWM.Relational.impl.TriggerImpl#getTable <em>Table</em>}</li>
 *   <li>{@link CWM.Relational.impl.TriggerImpl#getUsedColumnSet <em>Used Column Set</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
