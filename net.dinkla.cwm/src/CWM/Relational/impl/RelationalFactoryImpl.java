...
public class RelationalFactoryImpl extends EFactoryImpl implements RelationalFactory {
	...
	public static RelationalFactory init() {
		try {
			RelationalFactory theRelationalFactory = (RelationalFactory)EPackage.Registry.INSTANCE.getEFactory("Relational"); 
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			...
			case RelationalPackage.RELATIONAL_CONTAINER: return createRelational_container();
			default:
	 ...
	 * @generated
	 */
	public Relational_container createRelational_container() {
		Relational_containerImpl relational_container = new Relational_containerImpl();
