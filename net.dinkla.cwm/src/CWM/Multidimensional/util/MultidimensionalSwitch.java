...
public class MultidimensionalSwitch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case MultidimensionalPackage.MULTIDIMENSIONAL_CONTAINER: {
				Multidimensional_container multidimensional_container = (Multidimensional_container)theEObject;
				T result = caseMultidimensional_container(multidimensional_container);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Multidimensional container</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Multidimensional container</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseMultidimensional_container(Multidimensional_container object) {
		return null;
	}
