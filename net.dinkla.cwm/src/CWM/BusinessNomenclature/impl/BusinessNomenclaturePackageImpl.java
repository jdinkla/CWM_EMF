...
public class BusinessNomenclaturePackageImpl extends EPackageImpl implements BusinessNomenclaturePackage {
	 ...
	 * @generated
	 */
	private EClass businessNomenclature_containerEClass = null;
	 ...
	 * @see CWM.BusinessNomenclature.BusinessNomenclaturePackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	 ...
	 * @generated
	 */
	public EReference getTaxonomy_Domain() {
	 ...
	 * @generated
	 */
	public EReference getTaxonomy_Concept() {
	 ...
	 * @generated
	 */
	public EReference getTaxonomy_Subtaxonomy() {
	 ...
	 * @generated
	 */
	public EReference getGlossary_Subglossary() {
	 ...
	 * @generated
	 */
	public EReference getBusinessDomain_Taxonomy() {
	 ...
	 * @generated
	 */
	public EReference getConcept_Taxonomy() {
	 ...
	 * @generated
	 */
	public EReference getTerm_Glossary() {
	 ...
	 * @generated
	 */
	public EClass getBusinessNomenclature_container() {
		return businessNomenclature_containerEClass;
	}
	 ...
	 * @generated
	 */
	public EReference getBusinessNomenclature_container_VocabularyElement() {
		return (EReference)businessNomenclature_containerEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public EReference getBusinessNomenclature_container_Nomenclature() {
		return (EReference)businessNomenclature_containerEClass.getEStructuralFeatures().get(1);
	}
	 ...
	 * @generated
	 */
	public EReference getBusinessNomenclature_container_Taxonomy() {
		return (EReference)businessNomenclature_containerEClass.getEStructuralFeatures().get(2);
	}
	 ...
	 * @generated
	 */
	public EReference getBusinessNomenclature_container_Glossary() {
		return (EReference)businessNomenclature_containerEClass.getEStructuralFeatures().get(3);
	}
	 ...
	 * @generated
	 */
	public EReference getBusinessNomenclature_container_BusinessDomain() {
		return (EReference)businessNomenclature_containerEClass.getEStructuralFeatures().get(4);
	}
	 ...
	 * @generated
	 */
	public EReference getBusinessNomenclature_container_Concept() {
		return (EReference)businessNomenclature_containerEClass.getEStructuralFeatures().get(5);
	}
	 ...
	 * @generated
	 */
	public EReference getBusinessNomenclature_container_Term() {
		return (EReference)businessNomenclature_containerEClass.getEStructuralFeatures().get(6);
	}
	...
	public void createPackageContents() {
		...
		createEReference(taxonomyEClass, TAXONOMY__DOMAIN);
		createEReference(taxonomyEClass, TAXONOMY__CONCEPT);
		createEReference(taxonomyEClass, TAXONOMY__SUBTAXONOMY);
		...
		createEReference(glossaryEClass, GLOSSARY__SUBGLOSSARY);

		businessDomainEClass = createEClass(BUSINESS_DOMAIN);
		createEReference(businessDomainEClass, BUSINESS_DOMAIN__TAXONOMY);

		conceptEClass = createEClass(CONCEPT);
		createEReference(conceptEClass, CONCEPT__TAXONOMY);
		createEReference(conceptEClass, CONCEPT__RELATED_CONCEPT);

		termEClass = createEClass(TERM);
		createEReference(termEClass, TERM__GLOSSARY);
		...
		businessNomenclature_containerEClass = createEClass(BUSINESS_NOMENCLATURE_CONTAINER);
		createEReference(businessNomenclature_containerEClass, BUSINESS_NOMENCLATURE_CONTAINER__VOCABULARY_ELEMENT);
		createEReference(businessNomenclature_containerEClass, BUSINESS_NOMENCLATURE_CONTAINER__NOMENCLATURE);
		createEReference(businessNomenclature_containerEClass, BUSINESS_NOMENCLATURE_CONTAINER__TAXONOMY);
		createEReference(businessNomenclature_containerEClass, BUSINESS_NOMENCLATURE_CONTAINER__GLOSSARY);
		createEReference(businessNomenclature_containerEClass, BUSINESS_NOMENCLATURE_CONTAINER__BUSINESS_DOMAIN);
		createEReference(businessNomenclature_containerEClass, BUSINESS_NOMENCLATURE_CONTAINER__CONCEPT);
		createEReference(businessNomenclature_containerEClass, BUSINESS_NOMENCLATURE_CONTAINER__TERM);
	}
	...
	public void initializePackageContents() {
		...
		initEAttribute(getVocabularyElement_Definition(), theCorePackage.getString(), "definition", null, 1, 1, VocabularyElement.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEAttribute(getVocabularyElement_Example(), theCorePackage.getString(), "example", null, 1, 1, VocabularyElement.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEAttribute(getVocabularyElement_Usage(), theCorePackage.getString(), "usage", null, 1, 1, VocabularyElement.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEReference(getVocabularyElement_ModelElement(), theCorePackage.getModelElement(), null, "modelElement", null, 0, -1, VocabularyElement.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		...
		initEReference(getTaxonomy_Domain(), theCorePackage.getNamespace(), null, "domain", null, 0, 1, Taxonomy.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, !IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEReference(getTaxonomy_Concept(), theCorePackage.getModelElement(), null, "concept", null, 0, -1, Taxonomy.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEReference(getTaxonomy_Subtaxonomy(), this.getNomenclature(), null, "subtaxonomy", null, 0, -1, Taxonomy.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);

		initEClass(glossaryEClass, Glossary.class, "Glossary", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getGlossary_Language(), theCorePackage.getString(), "language", null, 1, 1, Glossary.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEReference(getGlossary_Taxonomy(), this.getTaxonomy(), null, "taxonomy", null, 0, -1, Glossary.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEReference(getGlossary_Term(), theCorePackage.getModelElement(), null, "term", null, 0, -1, Glossary.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEReference(getGlossary_Subglossary(), this.getNomenclature(), null, "subglossary", null, 0, -1, Glossary.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);

		initEClass(businessDomainEClass, BusinessDomain.class, "BusinessDomain", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getBusinessDomain_Taxonomy(), theCorePackage.getModelElement(), null, "taxonomy", null, 0, -1, BusinessDomain.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);

		initEClass(conceptEClass, Concept.class, "Concept", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getConcept_Taxonomy(), theCorePackage.getNamespace(), null, "taxonomy", null, 0, 1, Concept.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, !IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEReference(getConcept_RelatedConcept(), this.getConcept(), null, "relatedConcept", null, 0, -1, Concept.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);

		initEClass(termEClass, Term.class, "Term", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getTerm_Glossary(), theCorePackage.getNamespace(), null, "glossary", null, 0, 1, Term.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, !IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEReference(getTerm_Concept(), this.getConcept(), null, "concept", null, 0, -1, Term.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEReference(getTerm_RelatedTerm(), this.getTerm(), null, "relatedTerm", null, 0, -1, Term.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEReference(getTerm_PreferredTerm(), this.getTerm(), null, "preferredTerm", null, 0, 1, Term.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, !IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEReference(getTerm_NarrowerTerm(), this.getTerm(), null, "narrowerTerm", null, 0, -1, Term.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);

		initEClass(businessNomenclature_containerEClass, BusinessNomenclature_container.class, "BusinessNomenclature_container", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getBusinessNomenclature_container_VocabularyElement(), this.getVocabularyElement(), null, "VocabularyElement", null, 0, -1, BusinessNomenclature_container.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getBusinessNomenclature_container_Nomenclature(), this.getNomenclature(), null, "Nomenclature", null, 0, -1, BusinessNomenclature_container.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getBusinessNomenclature_container_Taxonomy(), this.getTaxonomy(), null, "Taxonomy", null, 0, -1, BusinessNomenclature_container.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getBusinessNomenclature_container_Glossary(), this.getGlossary(), null, "Glossary", null, 0, -1, BusinessNomenclature_container.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getBusinessNomenclature_container_BusinessDomain(), this.getBusinessDomain(), null, "BusinessDomain", null, 0, -1, BusinessNomenclature_container.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getBusinessNomenclature_container_Concept(), this.getConcept(), null, "Concept", null, 0, -1, BusinessNomenclature_container.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getBusinessNomenclature_container_Term(), this.getTerm(), null, "Term", null, 0, -1, BusinessNomenclature_container.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
	}
