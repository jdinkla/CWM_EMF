...
public class WarehouseOperationSwitch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case WarehouseOperationPackage.WAREHOUSE_OPERATION_CONTAINER: {
				WarehouseOperation_container warehouseOperation_container = (WarehouseOperation_container)theEObject;
				T result = caseWarehouseOperation_container(warehouseOperation_container);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Warehouse Operation container</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Warehouse Operation container</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseWarehouseOperation_container(WarehouseOperation_container object) {
		return null;
	}
