 ...
 * <ul>
 *   <li>{@link CWM.WarehouseOperation.impl.ChangeRequestImpl#getChangeDescription <em>Change Description</em>}</li>
 *   <li>{@link CWM.WarehouseOperation.impl.ChangeRequestImpl#getChangeReason <em>Change Reason</em>}</li>
 *   <li>{@link CWM.WarehouseOperation.impl.ChangeRequestImpl#getStatus <em>Status</em>}</li>
 *   <li>{@link CWM.WarehouseOperation.impl.ChangeRequestImpl#getCompleted <em>Completed</em>}</li>
 *   <li>{@link CWM.WarehouseOperation.impl.ChangeRequestImpl#getRequestDate <em>Request Date</em>}</li>
 *   <li>{@link CWM.WarehouseOperation.impl.ChangeRequestImpl#getCompletionDate <em>Completion Date</em>}</li>
 *   <li>{@link CWM.WarehouseOperation.impl.ChangeRequestImpl#getModelElement <em>Model Element</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ChangeRequestImpl extends ModelElementImpl implements ChangeRequest {
	 ...
	 * @ordered
	 */
	protected static final Boolean COMPLETED_EDEFAULT = null;
	...
	public EList<ModelElement> getModelElement() {
		if (modelElement == null) {
			modelElement = new EObjectResolvingEList<ModelElement>(ModelElement.class, this, WarehouseOperationPackage.CHANGE_REQUEST__MODEL_ELEMENT);
		}
		return modelElement;
	}
