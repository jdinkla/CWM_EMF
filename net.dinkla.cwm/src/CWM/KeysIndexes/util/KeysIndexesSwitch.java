...
public class KeysIndexesSwitch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case KeysIndexesPackage.KEYS_INDEXES_CONTAINER: {
				KeysIndexes_container keysIndexes_container = (KeysIndexes_container)theEObject;
				T result = caseKeysIndexes_container(keysIndexes_container);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Keys Indexes container</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Keys Indexes container</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseKeysIndexes_container(KeysIndexes_container object) {
		return null;
	}
