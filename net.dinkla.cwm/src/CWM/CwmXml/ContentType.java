 ...
 * <!-- end-user-doc -->
 * @see CWM.CwmXml.CwmXmlPackage#getContentType()
 * @model
 * @generated
 */
public enum ContentType implements Enumerator {
	 ...
	 * @ordered
	 */
	XML_EMPTY(1, "xml_empty", "xml_empty"),
	 ...
	 * @ordered
	 */
	XML_MIXED(3, "xml_mixed", "xml_mixed"),
	 ...
	 * @ordered
	 */
	XML_ELEMENT(4, "xml_element", "xml_element");
	 ...
	 * @ordered
	 */
	public static final int XML_EMPTY_VALUE = 1;
	 ...
	 * @ordered
	 */
	public static final int XML_ANY_VALUE = 2;
	 ...
	 * @ordered
	 */
	public static final int XML_MIXED_VALUE = 3;
	 ...
	 * @ordered
	 */
	public static final int XML_ELEMENT_VALUE = 4;
