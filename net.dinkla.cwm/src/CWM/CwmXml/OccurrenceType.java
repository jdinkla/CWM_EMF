 ...
 * <!-- end-user-doc -->
 * @see CWM.CwmXml.CwmXmlPackage#getOccurrenceType()
 * @model
 * @generated
 */
public enum OccurrenceType implements Enumerator {
	 ...
	 * @ordered
	 */
	XML_ZERO_OR_ONE(2, "xml_zeroOrOne", "xml_zeroOrOne"),
	 ...
	 * @ordered
	 */
	XML_ZERO_OR_MORE(3, "xml_zeroOrMore", "xml_zeroOrMore"),
	 ...
	 * @ordered
	 */
	XML_ONE_OR_MORE(4, "xml_oneOrMore", "xml_oneOrMore");
	 ...
	 * @ordered
	 */
	public static final int XML_ONE_VALUE = 1;
	 ...
	 * @ordered
	 */
	public static final int XML_ZERO_OR_ONE_VALUE = 2;
	 ...
	 * @ordered
	 */
	public static final int XML_ZERO_OR_MORE_VALUE = 3;
	 ...
	 * @ordered
	 */
	public static final int XML_ONE_OR_MORE_VALUE = 4;
