 ...
 * <!-- end-user-doc -->
 * @see CWM.CwmXml.CwmXmlPackage#getElementOrderType()
 * @model
 * @generated
 */
public enum ElementOrderType implements Enumerator {
	 ...
	 * @ordered
	 */
	XML_CHOICE(1, "xml_choice", "xml_choice"),
	 ...
	 * @ordered
	 */
	XML_SEQUENCE(2, "xml_sequence", "xml_sequence");
	 ...
	 * @ordered
	 */
	public static final int XML_CHOICE_VALUE = 1;
	 ...
	 * @ordered
	 */
	public static final int XML_SEQUENCE_VALUE = 2;
