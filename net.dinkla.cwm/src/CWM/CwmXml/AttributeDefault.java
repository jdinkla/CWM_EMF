 ...
 * <!-- end-user-doc -->
 * @see CWM.CwmXml.CwmXmlPackage#getAttributeDefault()
 * @model
 * @generated
 */
public enum AttributeDefault implements Enumerator {
	 ...
	 * @ordered
	 */
	XML_REQUIRED(1, "xml_required", "xml_required"),
	 ...
	 * @ordered
	 */
	XML_IMPLIED(2, "xml_implied", "xml_implied"),
	 ...
	 * @ordered
	 */
	XML_DEFAULT(3, "xml_default", "xml_default"),
	 ...
	 * @ordered
	 */
	XML_FIXED(4, "xml_fixed", "xml_fixed");
	 ...
	 * @ordered
	 */
	public static final int XML_REQUIRED_VALUE = 1;
	 ...
	 * @ordered
	 */
	public static final int XML_IMPLIED_VALUE = 2;
	 ...
	 * @ordered
	 */
	public static final int XML_DEFAULT_VALUE = 3;
	 ...
	 * @ordered
	 */
	public static final int XML_FIXED_VALUE = 4;
