 ...
 * <ul>
 *   <li>{@link CWM.CwmXml.impl.ContentImpl#getType <em>Type</em>}</li>
 *   <li>{@link CWM.CwmXml.impl.ContentImpl#getOccurrence <em>Occurrence</em>}</li>
 *   <li>{@link CWM.CwmXml.impl.ContentImpl#getElementType <em>Element Type</em>}</li>
 *   <li>{@link CWM.CwmXml.impl.ContentImpl#getOwnedElementType <em>Owned Element Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ContentImpl extends ModelElementImpl implements Content {
	...
	protected EClass eStaticClass() {
		return CwmXmlPackage.Literals.CONTENT;
	}
	...
	public void setType(ContentType newType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CwmXmlPackage.CONTENT__TYPE, oldType, type));
	}
	...
	public void setOccurrence(OccurrenceType newOccurrence) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CwmXmlPackage.CONTENT__OCCURRENCE, oldOccurrence, occurrence));
	}
	...
	public EList<ElementType> getElementType() {
		if (elementType == null) {
			elementType = new EObjectWithInverseResolvingEList<ElementType>(ElementType.class, this, CwmXmlPackage.CONTENT__ELEMENT_TYPE, CwmXmlPackage.ELEMENT_TYPE__CONTENT);
		}
		return elementType;
	}
	...
	public EList<ElementTypeReference> getOwnedElementType() {
		if (ownedElementType == null) {
			ownedElementType = new EObjectWithInverseResolvingEList.ManyInverse<ElementTypeReference>(ElementTypeReference.class, this, CwmXmlPackage.CONTENT__OWNED_ELEMENT_TYPE, CwmXmlPackage.ELEMENT_TYPE_REFERENCE__OWNER_CONTENT);
		}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case CwmXmlPackage.CONTENT__TYPE:
				return getType();
			case CwmXmlPackage.CONTENT__OCCURRENCE:
