...
public class RecordFactoryImpl extends EFactoryImpl implements RecordFactory {
	...
	public static RecordFactory init() {
		try {
			RecordFactory theRecordFactory = (RecordFactory)EPackage.Registry.INSTANCE.getEFactory("Record"); 
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			...
			case RecordPackage.RECORD_CONTAINER: return createRecord_container();
			default:
	 ...
	 * @generated
	 */
	public Record_container createRecord_container() {
		Record_containerImpl record_container = new Record_containerImpl();
