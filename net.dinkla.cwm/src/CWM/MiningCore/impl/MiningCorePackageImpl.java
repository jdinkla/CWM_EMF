 ...
 * @generated
 */
public class MiningCorePackageImpl extends EPackageImpl implements MiningCorePackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	private EClass miningCore_containerEClass = null;
	 ...
	 * @see CWM.MiningCore.MiningCorePackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private MiningCorePackageImpl() {
		super(eNS_URI, MiningCoreFactory.eINSTANCE);
	}
	 ...
	 * @generated
	 */
	public static MiningCorePackage init() {
		if (isInited) return (MiningCorePackage)EPackage.Registry.INSTANCE.getEPackage(MiningCorePackage.eNS_URI);

		// Obtain or create and register package
		MiningCorePackageImpl theMiningCorePackage = (MiningCorePackageImpl)(EPackage.Registry.INSTANCE.getEPackage(eNS_URI) instanceof MiningCorePackageImpl ? EPackage.Registry.INSTANCE.getEPackage(eNS_URI) : new MiningCorePackageImpl());
		...
		theMiningCorePackage.freeze();

		return theMiningCorePackage;
	}
	 ...
	 * @generated
	 */
	public EClass getMiningCore_container() {
		return miningCore_containerEClass;
	}
	 ...
	 * @generated
	 */
	public MiningCoreFactory getMiningCoreFactory() {
		return (MiningCoreFactory)getEFactoryInstance();
	}
	...
	public void createPackageContents() {
		...
		miningCore_containerEClass = createEClass(MINING_CORE_CONTAINER);
	}
	...
	public void initializePackageContents() {
		...
		// Add subpackages
		getESubpackages().add(theMiningDataPackage);
		getESubpackages().add(theMiningFunctionSettingsPackage);
		getESubpackages().add(theMiningModelPackage);
		getESubpackages().add(theMiningResultPackage);
		getESubpackages().add(theMiningTaskPackage);
		getESubpackages().add(theEntryPointPackage);
		...
		initEClass(miningCore_containerEClass, MiningCore_container.class, "MiningCore_container", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
	}

} //MiningCorePackageImpl
