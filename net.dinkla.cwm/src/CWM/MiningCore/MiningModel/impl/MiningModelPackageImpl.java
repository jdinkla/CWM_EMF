 ...
 * @generated
 */
public class MiningModelPackageImpl extends EPackageImpl implements MiningModelPackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @generated
	 */
	private EClass modelSignatureEClass = null;
	 ...
	 * @generated
	 */
	private EClass miningModel_containerEClass = null;
	 ...
	 * @generated
	 */
	private EEnum miningFunctionEEnum = null;
	 ...
	 * @see CWM.MiningCore.MiningModel.MiningModelPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private MiningModelPackageImpl() {
		super(eNS_URI, MiningModelFactory.eINSTANCE);
	}
	 ...
	 * @generated
	 */
	public static MiningModelPackage init() {
		if (isInited) return (MiningModelPackage)EPackage.Registry.INSTANCE.getEPackage(MiningModelPackage.eNS_URI);

		// Obtain or create and register package
		MiningModelPackageImpl theMiningModelPackage = (MiningModelPackageImpl)(EPackage.Registry.INSTANCE.getEPackage(eNS_URI) instanceof MiningModelPackageImpl ? EPackage.Registry.INSTANCE.getEPackage(eNS_URI) : new MiningModelPackageImpl());
		...
		theMiningModelPackage.freeze();

		return theMiningModelPackage;
	}
	 ...
	 * @generated
	 */
	public EAttribute getMiningModel_AlgorithmName() {
	 ...
	 * @generated
	 */
	public EReference getMiningModel_ModelSignature() {
	 ...
	 * @generated
	 */
	public EReference getMiningModel_ModelLocation() {
	 ...
	 * @generated
	 */
	public EReference getMiningModel_KeyAttribute() {
	 ...
	 * @generated
	 */
	public EAttribute getMiningModel_KeyValue() {
	 ...
	 * @generated
	 */
	public EClass getModelSignature() {
		return modelSignatureEClass;
	}
	 ...
	 * @generated
	 */
	public EAttribute getSignatureAttribute_UsageOption() {
	 ...
	 * @generated
	 */
	public EClass getMiningModel_container() {
		return miningModel_containerEClass;
	}
	 ...
	 * @generated
	 */
	public EReference getMiningModel_container_MiningModel() {
		return (EReference)miningModel_containerEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public EReference getMiningModel_container_ModelSignature() {
		return (EReference)miningModel_containerEClass.getEStructuralFeatures().get(1);
	}
	 ...
	 * @generated
	 */
	public EReference getMiningModel_container_SignatureAttribute() {
		return (EReference)miningModel_containerEClass.getEStructuralFeatures().get(2);
	}
	 ...
	 * @generated
	 */
	public MiningModelFactory getMiningModelFactory() {
		return (MiningModelFactory)getEFactoryInstance();
	}
	...
	public void createPackageContents() {
		...
		createEAttribute(miningModelEClass, MINING_MODEL__ALGORITHM_NAME);
		createEReference(miningModelEClass, MINING_MODEL__SETTINGS);
		createEReference(miningModelEClass, MINING_MODEL__MODEL_SIGNATURE);
		createEReference(miningModelEClass, MINING_MODEL__MODEL_LOCATION);
		createEReference(miningModelEClass, MINING_MODEL__KEY_ATTRIBUTE);
		createEAttribute(miningModelEClass, MINING_MODEL__KEY_VALUE);

		modelSignatureEClass = createEClass(MODEL_SIGNATURE);

		signatureAttributeEClass = createEClass(SIGNATURE_ATTRIBUTE);
		createEAttribute(signatureAttributeEClass, SIGNATURE_ATTRIBUTE__USAGE_OPTION);

		miningModel_containerEClass = createEClass(MINING_MODEL_CONTAINER);
		createEReference(miningModel_containerEClass, MINING_MODEL_CONTAINER__MINING_MODEL);
		createEReference(miningModel_containerEClass, MINING_MODEL_CONTAINER__MODEL_SIGNATURE);
		createEReference(miningModel_containerEClass, MINING_MODEL_CONTAINER__SIGNATURE_ATTRIBUTE);

		// Create enums
		miningFunctionEEnum = createEEnum(MINING_FUNCTION);
	}
	...
	public void initializePackageContents() {
		...
		miningModelEClass.getESuperTypes().add(theCorePackage.getModelElement());
		modelSignatureEClass.getESuperTypes().add(theCorePackage.getClass_());
		signatureAttributeEClass.getESuperTypes().add(theMiningDataPackage.getMiningAttribute());
		...
		initEAttribute(getMiningModel_Function(), this.getMiningFunction(), "function", null, 1, 1, MiningModel.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEAttribute(getMiningModel_AlgorithmName(), theCorePackage.getString(), "algorithmName", null, 1, 1, MiningModel.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEReference(getMiningModel_Settings(), theMiningFunctionSettingsPackage.getMiningFunctionSettings(), null, "settings", null, 0, 1, MiningModel.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, !IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEReference(getMiningModel_ModelSignature(), this.getModelSignature(), null, "modelSignature", null, 0, 1, MiningModel.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, !IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEReference(getMiningModel_ModelLocation(), theCorePackage.getClass_(), null, "modelLocation", null, 1, 1, MiningModel.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, !IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEReference(getMiningModel_KeyAttribute(), theCorePackage.getAttribute(), null, "keyAttribute", null, 1, 1, MiningModel.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, !IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEAttribute(getMiningModel_KeyValue(), theCorePackage.getAny(), "keyValue", null, 1, 1, MiningModel.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);

		initEClass(modelSignatureEClass, ModelSignature.class, "ModelSignature", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);

		initEClass(signatureAttributeEClass, SignatureAttribute.class, "SignatureAttribute", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getSignatureAttribute_UsageOption(), theMiningDataPackage.getUsageOption(), "usageOption", null, 1, 1, SignatureAttribute.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);

		initEClass(miningModel_containerEClass, MiningModel_container.class, "MiningModel_container", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getMiningModel_container_MiningModel(), this.getMiningModel(), null, "MiningModel", null, 0, -1, MiningModel_container.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getMiningModel_container_ModelSignature(), this.getModelSignature(), null, "ModelSignature", null, 0, -1, MiningModel_container.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getMiningModel_container_SignatureAttribute(), this.getSignatureAttribute(), null, "SignatureAttribute", null, 0, -1, MiningModel_container.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		// Initialize enums and add enum literals
		initEEnum(miningFunctionEEnum, MiningFunction.class, "MiningFunction");
		addEEnumLiteral(miningFunctionEEnum, MiningFunction.CLASSIFICATION);
		addEEnumLiteral(miningFunctionEEnum, MiningFunction.REGRESSION);
		addEEnumLiteral(miningFunctionEEnum, MiningFunction.CLUSTERING);
		addEEnumLiteral(miningFunctionEEnum, MiningFunction.ASSOCIATION_RULES);
		addEEnumLiteral(miningFunctionEEnum, MiningFunction.ATTRIBUTE_IMPORTANCE);
		addEEnumLiteral(miningFunctionEEnum, MiningFunction.SEQUENCE_ANALYSIS);
	}

} //MiningModelPackageImpl
