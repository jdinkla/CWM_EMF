 ...
 * @generated
 */
public class MiningResultAdapterFactory extends AdapterFactoryImpl {
	/**
	 ...
	 * @generated
	 */
	public MiningResultAdapterFactory() {
	 ...
	 * @generated
	 */
	protected MiningResultSwitch<Adapter> modelSwitch =
		new MiningResultSwitch<Adapter>() {
			@Override
			public Adapter caseMiningResult(MiningResult object) {
				return createMiningResultAdapter();
			}
			@Override
			public Adapter caseMiningResult_container(MiningResult_container object) {
				return createMiningResult_containerAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link CWM.MiningCore.MiningResult.MiningResult_container <em>Mining Result container</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createMiningResult_containerAdapter() {
		return null;
	}
