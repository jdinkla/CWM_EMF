 ...
 * @generated
 */
public class MiningResultPackageImpl extends EPackageImpl implements MiningResultPackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	private EClass miningResultEClass = null;
	 ...
	 * @generated
	 */
	private EClass miningResult_containerEClass = null;
	 ...
	 * @see CWM.MiningCore.MiningResult.MiningResultPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private MiningResultPackageImpl() {
		super(eNS_URI, MiningResultFactory.eINSTANCE);
	}
	 ...
	 * @generated
	 */
	public static MiningResultPackage init() {
		if (isInited) return (MiningResultPackage)EPackage.Registry.INSTANCE.getEPackage(MiningResultPackage.eNS_URI);

		// Obtain or create and register package
		MiningResultPackageImpl theMiningResultPackage = (MiningResultPackageImpl)(EPackage.Registry.INSTANCE.getEPackage(eNS_URI) instanceof MiningResultPackageImpl ? EPackage.Registry.INSTANCE.getEPackage(eNS_URI) : new MiningResultPackageImpl());
		...
		theMiningResultPackage.freeze();

		return theMiningResultPackage;
	}
	 ...
	 * @generated
	 */
	public EClass getMiningResult() {
		return miningResultEClass;
	}
	 ...
	 * @generated
	 */
	public EClass getMiningResult_container() {
		return miningResult_containerEClass;
	}
	 ...
	 * @generated
	 */
	public EReference getMiningResult_container_MiningResult() {
		return (EReference)miningResult_containerEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public MiningResultFactory getMiningResultFactory() {
		return (MiningResultFactory)getEFactoryInstance();
	}
	...
	public void createPackageContents() {
		...
		miningResultEClass = createEClass(MINING_RESULT);

		miningResult_containerEClass = createEClass(MINING_RESULT_CONTAINER);
		createEReference(miningResult_containerEClass, MINING_RESULT_CONTAINER__MINING_RESULT);
	}
	...
	public void initializePackageContents() {
		...
		miningResultEClass.getESuperTypes().add(theCorePackage.getModelElement());

		// Initialize classes and features; add operations and parameters
		initEClass(miningResultEClass, MiningResult.class, "MiningResult", IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);

		initEClass(miningResult_containerEClass, MiningResult_container.class, "MiningResult_container", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getMiningResult_container_MiningResult(), this.getMiningResult(), null, "MiningResult", null, 0, -1, MiningResult_container.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
	}

} //MiningResultPackageImpl
