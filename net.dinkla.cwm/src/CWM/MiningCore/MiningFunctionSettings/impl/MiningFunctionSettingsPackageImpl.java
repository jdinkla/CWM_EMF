 ...
 * @generated
 */
public class MiningFunctionSettingsPackageImpl extends EPackageImpl implements MiningFunctionSettingsPackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	private EClass miningAlgorithmSettingsEClass = null;
	 ...
	 * @generated
	 */
	private EClass miningFunctionSettingsEClass = null;
	 ...
	 * @generated
	 */
	private EClass miningFunctionSettings_containerEClass = null;
	 ...
	 * @see CWM.MiningCore.MiningFunctionSettings.MiningFunctionSettingsPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private MiningFunctionSettingsPackageImpl() {
		super(eNS_URI, MiningFunctionSettingsFactory.eINSTANCE);
	}
	 ...
	 * @generated
	 */
	public static MiningFunctionSettingsPackage init() {
		if (isInited) return (MiningFunctionSettingsPackage)EPackage.Registry.INSTANCE.getEPackage(MiningFunctionSettingsPackage.eNS_URI);

		// Obtain or create and register package
		MiningFunctionSettingsPackageImpl theMiningFunctionSettingsPackage = (MiningFunctionSettingsPackageImpl)(EPackage.Registry.INSTANCE.getEPackage(eNS_URI) instanceof MiningFunctionSettingsPackageImpl ? EPackage.Registry.INSTANCE.getEPackage(eNS_URI) : new MiningFunctionSettingsPackageImpl());
		...
		theMiningFunctionSettingsPackage.freeze();

		return theMiningFunctionSettingsPackage;
	}
	 ...
	 * @generated
	 */
	public EClass getMiningAlgorithmSettings() {
		return miningAlgorithmSettingsEClass;
	}
	 ...
	 * @generated
	 */
	public EClass getMiningFunctionSettings() {
		return miningFunctionSettingsEClass;
	}
	 ...
	 * @generated
	 */
	public EReference getMiningFunctionSettings_AlgorithmSettings() {
		return (EReference)miningFunctionSettingsEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public EAttribute getMiningFunctionSettings_DesiredExecutionTimeInMinutes() {
		return (EAttribute)miningFunctionSettingsEClass.getEStructuralFeatures().get(1);
	}
	 ...
	 * @generated
	 */
	public EReference getMiningFunctionSettings_AttributeUsageSet() {
		return (EReference)miningFunctionSettingsEClass.getEStructuralFeatures().get(2);
	}
	 ...
	 * @generated
	 */
	public EReference getMiningFunctionSettings_LogicalData() {
		return (EReference)miningFunctionSettingsEClass.getEStructuralFeatures().get(3);
	}
	 ...
	 * @generated
	 */
	public EClass getMiningFunctionSettings_container() {
		return miningFunctionSettings_containerEClass;
	}
	 ...
	 * @generated
	 */
	public EReference getMiningFunctionSettings_container_MiningAlgorithmSettings() {
		return (EReference)miningFunctionSettings_containerEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public EReference getMiningFunctionSettings_container_MiningFunctionSettings() {
		return (EReference)miningFunctionSettings_containerEClass.getEStructuralFeatures().get(1);
	}
	 ...
	 * @generated
	 */
	public MiningFunctionSettingsFactory getMiningFunctionSettingsFactory() {
		return (MiningFunctionSettingsFactory)getEFactoryInstance();
	}
	...
	public void createPackageContents() {
		...
		miningAlgorithmSettingsEClass = createEClass(MINING_ALGORITHM_SETTINGS);

		miningFunctionSettingsEClass = createEClass(MINING_FUNCTION_SETTINGS);
		createEReference(miningFunctionSettingsEClass, MINING_FUNCTION_SETTINGS__ALGORITHM_SETTINGS);
		createEAttribute(miningFunctionSettingsEClass, MINING_FUNCTION_SETTINGS__DESIRED_EXECUTION_TIME_IN_MINUTES);
		createEReference(miningFunctionSettingsEClass, MINING_FUNCTION_SETTINGS__ATTRIBUTE_USAGE_SET);
		createEReference(miningFunctionSettingsEClass, MINING_FUNCTION_SETTINGS__LOGICAL_DATA);

		miningFunctionSettings_containerEClass = createEClass(MINING_FUNCTION_SETTINGS_CONTAINER);
		createEReference(miningFunctionSettings_containerEClass, MINING_FUNCTION_SETTINGS_CONTAINER__MINING_ALGORITHM_SETTINGS);
		createEReference(miningFunctionSettings_containerEClass, MINING_FUNCTION_SETTINGS_CONTAINER__MINING_FUNCTION_SETTINGS);
	}
	...
	public void initializePackageContents() {
		...
		miningAlgorithmSettingsEClass.getESuperTypes().add(theCorePackage.getModelElement());
		miningFunctionSettingsEClass.getESuperTypes().add(theCorePackage.getModelElement());

		// Initialize classes and features; add operations and parameters
		initEClass(miningAlgorithmSettingsEClass, MiningAlgorithmSettings.class, "MiningAlgorithmSettings", IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);

		initEClass(miningFunctionSettingsEClass, MiningFunctionSettings.class, "MiningFunctionSettings", IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getMiningFunctionSettings_AlgorithmSettings(), this.getMiningAlgorithmSettings(), null, "algorithmSettings", null, 0, 1, MiningFunctionSettings.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, !IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEAttribute(getMiningFunctionSettings_DesiredExecutionTimeInMinutes(), theCorePackage.getInteger(), "desiredExecutionTimeInMinutes", null, 1, 1, MiningFunctionSettings.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEReference(getMiningFunctionSettings_AttributeUsageSet(), theMiningDataPackage.getAttributeUsageSet(), null, "attributeUsageSet", null, 0, 1, MiningFunctionSettings.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, !IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEReference(getMiningFunctionSettings_LogicalData(), theMiningDataPackage.getLogicalData(), null, "logicalData", null, 1, 1, MiningFunctionSettings.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, !IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);

		initEClass(miningFunctionSettings_containerEClass, MiningFunctionSettings_container.class, "MiningFunctionSettings_container", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getMiningFunctionSettings_container_MiningAlgorithmSettings(), this.getMiningAlgorithmSettings(), null, "MiningAlgorithmSettings", null, 0, -1, MiningFunctionSettings_container.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getMiningFunctionSettings_container_MiningFunctionSettings(), this.getMiningFunctionSettings(), null, "MiningFunctionSettings", null, 0, -1, MiningFunctionSettings_container.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
	}
