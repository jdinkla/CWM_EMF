...
public class OlapSwitch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case OlapPackage.HIERARCHY_MEMBER_SELECTION_GROUP: {
				HierarchyMemberSelectionGroup hierarchyMemberSelectionGroup = (HierarchyMemberSelectionGroup)theEObject;
				T result = caseHierarchyMemberSelectionGroup(hierarchyMemberSelectionGroup);
				if (result == null) result = caseMemberSelectionGroup(hierarchyMemberSelectionGroup);
				if (result == null) result = caseClass(hierarchyMemberSelectionGroup);
				if (result == null) result = caseClassifier(hierarchyMemberSelectionGroup);
				if (result == null) result = caseNamespace(hierarchyMemberSelectionGroup);
				if (result == null) result = caseModelElement(hierarchyMemberSelectionGroup);
				if (result == null) result = caseElement(hierarchyMemberSelectionGroup);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case OlapPackage.OLAP_CONTAINER: {
				Olap_container olap_container = (Olap_container)theEObject;
				T result = caseOlap_container(olap_container);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Hierarchy Member Selection Group</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Hierarchy Member Selection Group</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseHierarchyMemberSelectionGroup(HierarchyMemberSelectionGroup object) {
		return null;
	}

	/**
	 * Returns the result of interpreting the object as an instance of '<em>Olap container</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Olap container</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseOlap_container(Olap_container object) {
		return null;
	}
