...
public class OlapFactoryImpl extends EFactoryImpl implements OlapFactory {
	...
	public static OlapFactory init() {
		try {
			OlapFactory theOlapFactory = (OlapFactory)EPackage.Registry.INSTANCE.getEFactory("Olap"); 
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			...
			case OlapPackage.HIERARCHY_MEMBER_SELECTION_GROUP: return createHierarchyMemberSelectionGroup();
			case OlapPackage.OLAP_CONTAINER: return createOlap_container();
			default:
	 ...
	 * @generated
	 */
	public HierarchyMemberSelectionGroup createHierarchyMemberSelectionGroup() {
		HierarchyMemberSelectionGroupImpl hierarchyMemberSelectionGroup = new HierarchyMemberSelectionGroupImpl();
	 ...
	 * @generated
	 */
	public Olap_container createOlap_container() {
		Olap_containerImpl olap_container = new Olap_containerImpl();
		return olap_container;
	}
