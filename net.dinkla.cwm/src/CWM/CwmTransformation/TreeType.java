 ...
 * <!-- end-user-doc -->
 * @see CWM.CwmTransformation.CwmTransformationPackage#getTreeType()
 * @model
 * @generated
 */
public enum TreeType implements Enumerator {
	 ...
	 * @ordered
	 */
	TFM_UNARY(1, "tfm_unary", "tfm_unary"),
	 ...
	 * @ordered
	 */
	TFM_BINARY(2, "tfm_binary", "tfm_binary");
	 ...
	 * @ordered
	 */
	public static final int TFM_UNARY_VALUE = 1;
	 ...
	 * @ordered
	 */
	public static final int TFM_BINARY_VALUE = 2;
